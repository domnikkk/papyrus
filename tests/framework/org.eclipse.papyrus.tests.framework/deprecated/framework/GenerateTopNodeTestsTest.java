...
//	private static GenerateTopNodeTestCode m2t;
	...
	public static void setUp() {
		String[] templateNames = { "generateTopNodeTestsFromPapyrusTesting" };
		String moduleName = "generateTopNodeTestsFromPapyrusTesting";
...
//		m2t.setModuleFileName(moduleName);
	...
	public void testGenerateClassDiagramTopNodeTests() throws IOException {
		URI inURI = URI.createURI("platform:/resource/org.eclipse.papyrus.uml.diagram.clazz/model/classdiagram.gmfgen");
	...
	public void testGenerateComponentDiagramTopNodeTests() throws IOException {
		URI inURI = URI.createURI("platform:/resource/org.eclipse.papyrus.uml.diagram.component/model/ComponentDiagram.gmfgen");
	...
	public void testGenerateDeploymentDiagramTopNodeTests() throws IOException {
		URI inURI = URI.createURI("platform:/resource/org.eclipse.papyrus.uml.diagram.deployment/model/DeploymentDiagram.gmfgen");
	...
	private void doGenerate(URI inURI, String srcGenOutputPath, URI papyrusTestingModelURI)
		...
		final QvtoTransformation generatePapyrusTestingModel = new QvtoTransformation();
//		ExecutionDiagnostic result = generatePapyrusTestingModel.generate(transformationURI, papyrusTestingModelURI);
