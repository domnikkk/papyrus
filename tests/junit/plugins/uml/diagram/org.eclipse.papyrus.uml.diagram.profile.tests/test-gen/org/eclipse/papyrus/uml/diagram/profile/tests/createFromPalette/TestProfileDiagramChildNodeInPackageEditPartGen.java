...
/**
 * The Class TestProfileDiagramChildNodeInPackageEditPartGen.
 */
public class TestProfileDiagramChildNodeInPackageEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeStereotypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StereotypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeProfileEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProfileEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeMetaclassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(MetaclassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Class.
	 */
