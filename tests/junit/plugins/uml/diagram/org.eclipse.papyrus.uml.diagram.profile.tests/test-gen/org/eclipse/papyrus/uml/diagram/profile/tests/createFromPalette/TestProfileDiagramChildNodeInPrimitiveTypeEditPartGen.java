...
/**
 * The Class TestProfileDiagramChildNodeInPrimitiveTypeEditPartGen.
 */
public class TestProfileDiagramChildNodeInPrimitiveTypeEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeProfileEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProfileEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(PrimitiveTypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeMetaclassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(MetaclassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(PrimitiveTypeEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Class.
	 */
	...
	public void testChildNodeStereotypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StereotypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(PrimitiveTypeEditPart.VISUAL_ID), true);
	}
	/**
