...
/**
 * The Class TestProfileDiagramChildNodeInConstraintEditPartGen.
 */
public class TestProfileDiagramChildNodeInConstraintEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeProfileEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProfileEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ConstraintEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeMetaclassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(MetaclassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ConstraintEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeStereotypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StereotypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ConstraintEditPart.VISUAL_ID), true);
	}
	/**
