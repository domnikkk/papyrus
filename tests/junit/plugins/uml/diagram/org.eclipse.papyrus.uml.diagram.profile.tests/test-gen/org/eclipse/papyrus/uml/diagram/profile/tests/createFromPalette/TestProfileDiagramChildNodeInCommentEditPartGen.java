...
/**
 * The Class TestProfileDiagramChildNodeInCommentEditPartGen.
 */
public class TestProfileDiagramChildNodeInCommentEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeProfileEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProfileEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeMetaclassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(MetaclassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeStereotypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StereotypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Class.
	 */
