...
/**
 * The Class TestProfileDiagramChildNodeInDataTypeEditPartGen.
 */
public class TestProfileDiagramChildNodeInDataTypeEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeMetaclassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(MetaclassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DataTypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeStereotypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StereotypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DataTypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeProfileEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProfileEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DataTypeEditPart.VISUAL_ID), true);
	}
	/**
