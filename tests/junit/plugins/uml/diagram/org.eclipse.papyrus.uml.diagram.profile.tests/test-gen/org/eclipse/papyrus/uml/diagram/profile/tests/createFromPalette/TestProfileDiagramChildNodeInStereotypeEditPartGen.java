...
/**
 * The Class TestProfileDiagramChildNodeInStereotypeEditPartGen.
 */
public class TestProfileDiagramChildNodeInStereotypeEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeProfileEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProfileEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeConstraintEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ConstraintEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeDataTypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(DataTypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeStereotypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StereotypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePrimitiveTypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PrimitiveTypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeClassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ClassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePackageEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PackageEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeEnumerationEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(EnumerationEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCommentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CommentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Class.
	 */
	...
	public void testChildNodeMetaclassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(MetaclassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeModelEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ModelEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), true);
	}
	...
	protected CreateViewRequest createViewRequestShapeContainer() {
		return CreateViewRequestFactory.getCreateShapeRequest(UMLElementTypes.getElementType(StereotypeEditPart.VISUAL_ID), getDiagramEditPart().getDiagramPreferencesHint());
	}
