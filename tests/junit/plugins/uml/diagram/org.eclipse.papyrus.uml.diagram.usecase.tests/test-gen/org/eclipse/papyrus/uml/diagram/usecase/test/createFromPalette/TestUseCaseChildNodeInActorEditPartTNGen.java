...
/**
 * The Class TestUseCaseChildNodeInActorEditPartTNGen.
 */
public class TestUseCaseChildNodeInActorEditPartTNGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeUseCaseInPackageEditPart() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(UseCaseInPackageEditPart.VISUAL_ID), UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePackageEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PackageEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeComponentInPackageEditPart() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ComponentInPackageEditPart.VISUAL_ID), UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCommentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CommentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeActorInPackageEditPart() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ActorInPackageEditPart.VISUAL_ID), UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeConstraintInPackageEditPart() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ConstraintInPackageEditPart.VISUAL_ID), UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), true);
	}
	...
	protected CreateViewRequest createViewRequestShapeContainer() {
		return CreateViewRequestFactory.getCreateShapeRequest(UMLElementTypes.getElementType(ActorEditPartTN.VISUAL_ID), getDiagramEditPart().getDiagramPreferencesHint());
	}
