 ...
 */
public class TestClassDiagramTopNodeGen extends TestTopNode {
	...
	public void testTopNodeDataTypeEditPart() {
		testToManageNode(UMLElementTypes.getElementType(DataTypeEditPart.VISUAL_ID), UMLPackage.eINSTANCE.getDataType()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testTopNodePrimitiveTypeEditPart() {
		testToManageNode(UMLElementTypes.getElementType(PrimitiveTypeEditPart.VISUAL_ID), UMLPackage.eINSTANCE.getPrimitiveType()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testTopNodeEnumerationEditPart() {
		testToManageNode(UMLElementTypes.getElementType(EnumerationEditPart.VISUAL_ID), UMLPackage.eINSTANCE.getEnumeration()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testTopNodeModelEditPartTN() {
		testToManageNode(UMLElementTypes.getElementType(ModelEditPartTN.VISUAL_ID), UMLPackage.eINSTANCE.getModel()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testTopNodeSignalEditPart() {
		testToManageNode(UMLElementTypes.getElementType(SignalEditPart.VISUAL_ID), UMLPackage.eINSTANCE.getSignal()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testTopNodeInstanceSpecificationEditPart() {
		testToManageNode(UMLElementTypes.getElementType(InstanceSpecificationEditPart.VISUAL_ID), UMLPackage.eINSTANCE.getInstanceSpecification()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testTopNodeClassEditPart() {
		testToManageNode(UMLElementTypes.getElementType(ClassEditPart.VISUAL_ID), UMLPackage.eINSTANCE.getClass_()
		, UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
