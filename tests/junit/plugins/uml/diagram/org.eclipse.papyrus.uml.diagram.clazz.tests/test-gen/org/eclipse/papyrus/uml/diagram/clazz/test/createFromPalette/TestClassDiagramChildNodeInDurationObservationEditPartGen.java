...
/**
 * The Class TestClassDiagramChildNodeInDurationObservationEditPartGen.
 */
public class TestClassDiagramChildNodeInDurationObservationEditPartGen extends AbstractCreateNodeFromPaletteTest {
	...
	public void testChildNodeEnumerationEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(EnumerationEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeSignalEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(SignalEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePrimitiveTypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PrimitiveTypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePackageEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PackageEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeClassEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ClassEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeConstraintEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ConstraintEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeComponentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ComponentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeDataTypeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(DataTypeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeInstanceSpecificationEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(InstanceSpecificationEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeModelEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ModelEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(DurationObservationEditPart.VISUAL_ID), true);
	}
