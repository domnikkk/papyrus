...
/**
 * The Class TestComponentDiagramChildNodeInPackageEditPartGen.
 */
public class TestComponentDiagramChildNodeInPackageEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeComponentEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ComponentEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCommentEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CommentEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeConstraintEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ConstraintEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeInterfaceEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(InterfaceEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(PackageEditPart.VISUAL_ID), true);
	}
