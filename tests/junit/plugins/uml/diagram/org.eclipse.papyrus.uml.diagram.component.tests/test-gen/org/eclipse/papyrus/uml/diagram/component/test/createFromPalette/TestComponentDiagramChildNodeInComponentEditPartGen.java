...
/**
 * The Class TestComponentDiagramChildNodeInComponentEditPartGen.
 */
public class TestComponentDiagramChildNodeInComponentEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeCommentEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CommentEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(ComponentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeComponentEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ComponentEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(ComponentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeInterfaceEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(InterfaceEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(ComponentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeConstraintEditPartPCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ConstraintEditPartPCN.VISUAL_ID), UMLElementTypes.getElementType(ComponentEditPart.VISUAL_ID), true);
	}
