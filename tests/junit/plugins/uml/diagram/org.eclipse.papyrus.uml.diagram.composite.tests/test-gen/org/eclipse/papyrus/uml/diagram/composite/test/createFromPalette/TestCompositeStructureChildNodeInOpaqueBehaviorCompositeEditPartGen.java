...
/**
 * The Class TestCompositeStructureChildNodeInOpaqueBehaviorCompositeEditPartGen.
 */
public class TestCompositeStructureChildNodeInOpaqueBehaviorCompositeEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeOpaqueBehaviorCompositeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeProtocolStateMachineCompositeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ProtocolStateMachineCompositeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeDurationConstraintEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(DurationConstraintEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePropertyPartEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PropertyPartEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCollaborationRoleEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CollaborationRoleEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCommentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CommentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCollaborationUseEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CollaborationUseEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeFunctionBehaviorCompositeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(FunctionBehaviorCompositeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeCollaborationCompositeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CollaborationCompositeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeInformationItemEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(InformationItemEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeTimeConstraintEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(TimeConstraintEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), true);
	}
	...
	protected CreateViewRequest createViewRequestShapeContainer() {
		return CreateViewRequestFactory.getCreateShapeRequest(UMLElementTypes.getElementType(OpaqueBehaviorCompositeEditPart.VISUAL_ID), getDiagramEditPart().getDiagramPreferencesHint());
	}
