...
/**
 * The Class TestStateMachineDiagramTopNodeGen.
 */
public class TestStateMachineDiagramTopNodeGen extends CreateNodeFromPaletteTest {
	...
	@Test
	@GeneratedTest
	public void testTopNodeStateMachineEditPart() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(StateMachineEditPart.VISUAL_ID), UMLElementTypes.getElementType(StateMachineEditPart.VISUAL_ID), true);
	}
