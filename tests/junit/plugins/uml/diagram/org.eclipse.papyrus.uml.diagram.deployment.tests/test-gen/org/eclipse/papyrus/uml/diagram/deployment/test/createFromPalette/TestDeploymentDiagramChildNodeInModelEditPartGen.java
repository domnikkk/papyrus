...
/**
 * The Class TestDeploymentDiagramChildNodeInModelEditPartGen.
 */
public class TestDeploymentDiagramChildNodeInModelEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeCommentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(CommentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeArtifactEditPartACN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ArtifactEditPartACN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeDeviceEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(DeviceEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeNestedNodeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedNodeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Artifact.
	 */
	...
	public void testChildNodeArtifactEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ArtifactEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeNestedExecutionEnvironmentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedExecutionEnvironmentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeConstraintEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ConstraintEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component ExecutionEnvironment.
	 */
	...
	public void testChildNodeExecutionEnvironmentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ExecutionEnvironmentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodePackageEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(PackageEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Device.
	 */
	...
	public void testChildNodeNestedDeviceEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedDeviceEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Artifact.
	 */
	...
	public void testChildNodeNestedArtifactNodeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedArtifactNodeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Node.
	 */
	...
	public void testChildNodeNodeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NodeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeModelEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ModelEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), true);
	}
	...
	protected CreateViewRequest createViewRequestShapeContainer() {
		return CreateViewRequestFactory.getCreateShapeRequest(UMLElementTypes.getElementType(ModelEditPart.VISUAL_ID), getDiagramEditPart().getDiagramPreferencesHint());
	}
