...
/**
 * The Class TestDeploymentDiagramChildNodeInCommentEditPartGen.
 */
public class TestDeploymentDiagramChildNodeInCommentEditPartGen extends CreateNodeFromPaletteTest {
	...
	public void testChildNodeArtifactEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ArtifactEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeNestedExecutionEnvironmentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedExecutionEnvironmentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeNestedDeviceEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedDeviceEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeNestedNodeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedNodeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	...
	public void testChildNodeArtifactEditPartACN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ArtifactEditPartACN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Artifact.
	 */
	...
	public void testChildNodeNestedArtifactNodeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NestedArtifactNodeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Device.
	 */
	...
	public void testChildNodeDeviceEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(DeviceEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component ExecutionEnvironment.
	 */
	...
	public void testChildNodeExecutionEnvironmentEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(ExecutionEnvironmentEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
	/**
	 * Test to manage component Node.
	 */
	...
	public void testChildNodeNodeEditPartCN() {
		testCreateNodeFromPalette(UMLElementTypes.getElementType(NodeEditPartCN.VISUAL_ID), UMLElementTypes.getElementType(CommentEditPart.VISUAL_ID), true);
	}
