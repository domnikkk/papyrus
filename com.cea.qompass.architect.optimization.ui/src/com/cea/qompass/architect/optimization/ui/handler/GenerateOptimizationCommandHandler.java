...
import com.cea.qompass.architect.optimization.ui.Activator;
import com.cea.qompass.architect.ui.common.handlers.AbstractCommandHandler;
 ...
 */
public class GenerateOptimizationCommandHandler  extends AbstractCommandHandler {

	/** The rtmaps folder. */
	private final String MILPFolder = "MILP-generated-files";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if(selection instanceof IStructuredSelection) {
			...
			int lastSegment = resourceURI.segmentCount() - 2;
			URI targetFolderURI = resourceURI.trimSegments(lastSegment).appendSegment(MILPFolder);
			...
			try {
				...
				ICommand generationCommand = new GenerateMWEOptimizationCodeCommand("Generate Optimization code command", editingDomain, selectedElement, targetFolderURI.toPlatformString(true));
	...
	public boolean isEnabled() {
		Object obj;
		obj = EMFHelper.getEObject(getSelectedEObject());
		if (obj instanceof Element){
			Element element = (Element) obj;
			Element owner = element.getOwner();
				if (hasStereotype(owner,"OptimizationProblems")&& (element instanceof org.eclipse.uml2.uml.Class))
				{
					return true;
				}
		}
