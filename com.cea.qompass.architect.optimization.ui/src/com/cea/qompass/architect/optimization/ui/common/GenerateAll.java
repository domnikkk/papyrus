 ...
 *******************************************************************************/
package com.cea.qompass.architect.optimization.ui.common;
...
public class GenerateAll {
	...
	public void doGenerate(IProgressMonitor monitor) throws IOException {
		...
		Generate_data gen0 = new Generate_data(modelURI, targetFolder.getLocation().toFile(), arguments);
		monitor.worked(1);
		String generationID = org.eclipse.acceleo.engine.utils.AcceleoLaunchingUtil.computeUIProjectID("com.cea.qompass.architect.optimization.codegen", "com.cea.qompass.architect.optimization.codegen.main.Generate_data", modelURI.toString(), targetFolder.getFullPath().toString(), new ArrayList<String>());
