 ...
 */
public class GenerateOptimizationCodeCommand extends AbstractTransactionalCommand {
	 ...
	 *        the rtmaps target folder path
	 */
	public GenerateOptimizationCodeCommand(String label, TransactionalEditingDomain domain, EObject selectedElement, String rtmapsTargetFolderPath) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		AcceleoOptimizationCodeGenerator codeGenerator = new AcceleoOptimizationCodeGenerator();
