...
public class UMLRealTimeStateMachXMLProcessor extends XMLProcessor {
	...
	protected Map<String, Resource.Factory> getRegistrations() {
		if (registrations == null) {
			...
			registrations.put(XML_EXTENSION, new UMLRealTimeStateMachResourceFactoryImpl());
			registrations.put(STAR_EXTENSION, new UMLRealTimeStateMachResourceFactoryImpl());
		}
