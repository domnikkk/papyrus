 ...
 *****************************************************************************/
package org.eclipse.papyrus.bpmn.diagram.common.utils;
 ...
 *
 */
public class BpmnSelectionTester extends PropertyTester {

	/** Tester ID for UML Model nature */
	public final static String IS_BPMN_MODEL = "isBpmnModel";


	/** Default constructor */
	public BpmnSelectionTester() {
	}
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		...
		if (IS_BPMN_MODEL.equals(property)) {
			currentValue = testBpmnModelNature(receiver);
	...
	/** True is root object is a UML Model with BPMN Profile (and sub profiles) applied */
	protected boolean testBpmnModelNature(Object receiver) {
		...
		if (root instanceof Package) {
			return (((Package) root).getAppliedProfile("BPMNProfile") != null);
	...
	private EObject getRoot(Object receiver) {
		...
		if (receiver instanceof ISelection) {
			...
			try {
				...
				// Do not log exceptions: this is just not a Papyrus/BPMN model
			}
		}
