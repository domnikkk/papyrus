...
public class BehaviorImpl extends ContextImpl implements Behavior {
	...
	public EList<FunctionBehavior> getBehavior() {
		...
		if (getBase_NamedElement() != null) {
			...
			while (it.hasNext()) {
				...
				adlBehavior = (FunctionBehavior )UMLUtil.getStereotypeApplication(element, FunctionBehavior.class);
				if (adlBehavior != null)
	...
	public EList<FunctionTrigger> getFunctionTrigger() {
		...
		if (getBase_NamedElement() != null) {
			...
			while (it.hasNext()) {
				Element element = it.next();
				adlTrigger = (FunctionTrigger )UMLUtil.getStereotypeApplication(element, FunctionTrigger.class);
				if (adlTrigger != null)
	...
	public EList<ModeGroup> getModeGroup() {
		...
		if (getBase_NamedElement() != null) {
			...
			while (it.hasNext()) {
				Element element = it.next();
				adlModeGroup = (ModeGroup )UMLUtil.getStereotypeApplication(element, ModeGroup.class);
