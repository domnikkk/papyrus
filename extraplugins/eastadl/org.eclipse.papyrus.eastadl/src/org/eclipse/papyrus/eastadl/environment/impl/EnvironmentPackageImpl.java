...
public class EnvironmentPackageImpl extends EPackageImpl implements EnvironmentPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getClampConnector_Port(), theInfrastructurePackage.getClampConnectorInstanceRef(), null, "port", null, 2, 2, ClampConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	}
