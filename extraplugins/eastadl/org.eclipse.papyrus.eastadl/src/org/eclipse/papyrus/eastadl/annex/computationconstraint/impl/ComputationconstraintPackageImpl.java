...
public class ComputationconstraintPackageImpl extends EPackageImpl implements ComputationconstraintPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link ComputationconstraintPackage#eINSTANCE} when that field is accessed.
	...
	public static ComputationconstraintPackage init() {
		if (isInited) return (ComputationconstraintPackage)EPackage.Registry.INSTANCE.getEPackage(ComputationconstraintPackage.eNS_URI);

		// Obtain or create and register package
		ComputationconstraintPackageImpl theComputationconstraintPackage = (ComputationconstraintPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ComputationconstraintPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ComputationconstraintPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getComputationConstraint_LogicalPath(), this.getLogicalPath(), null, "logicalPath", null, 0, -1, ComputationConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getComputationConstraint_LogicalTransformation(), this.getLogicalTransformation(), null, "logicalTransformation", null, 0, -1, ComputationConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getLogicalPath_TransformationOccurrence(), this.getTransformationOccurrence(), null, "transformationOccurrence", null, 0, 1, LogicalPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalPath_PrecedingExecutionEventChain(), theTimingPackage.getEventChain(), null, "precedingExecutionEventChain", null, 0, -1, LogicalPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalPath_SucceedingExecutionEventChain(), theTimingPackage.getEventChain(), null, "succeedingExecutionEventChain", null, 0, -1, LogicalPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalPath_CorrespondingExecutionEventChain(), theTimingPackage.getEventChain(), null, "correspondingExecutionEventChain", null, 0, -1, LogicalPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalPath_LogicalResponse(), theAttributequantificationconstraintPackage.getLogicalEvent(), null, "logicalResponse", null, 0, -1, LogicalPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalPath_LogicalStimulus(), theAttributequantificationconstraintPackage.getLogicalEvent(), null, "logicalStimulus", null, 0, -1, LogicalPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getLogicalTransformation_IsClientServerInterface(), theTypesPackage.getBoolean(), "isClientServerInterface", "false", 1, 1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_ClientServerinterfaceOperation(), theFunctionmodelingPackage.getOperation(), null, "clientServerinterfaceOperation", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_Contained(), theAttributequantificationconstraintPackage.getAttribute(), null, "contained", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_Out(), theAttributequantificationconstraintPackage.getAttribute(), null, "out", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_In(), theAttributequantificationconstraintPackage.getAttribute(), null, "in", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_Expression(), theValuesPackage.getEAExpression(), null, "expression", null, 0, 1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_QuantificationInvariant(), theAttributequantificationconstraintPackage.getQuantification(), null, "quantificationInvariant", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_PreCondition(), theAttributequantificationconstraintPackage.getQuantification(), null, "preCondition", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_PostCondition(), theAttributequantificationconstraintPackage.getQuantification(), null, "postCondition", null, 0, -1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLogicalTransformation_TimeInvariant(), theTemporalconstraintPackage.getLogicalTimeCondition(), null, "timeInvariant", null, 0, 1, LogicalTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTransformationOccurrence_InQuantification(), theAttributequantificationconstraintPackage.getQuantification(), null, "inQuantification", null, 0, -1, TransformationOccurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTransformationOccurrence_OutQuantification(), theAttributequantificationconstraintPackage.getQuantification(), null, "outQuantification", null, 0, -1, TransformationOccurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTransformationOccurrence_InvokedLogicalTransformation(), this.getLogicalTransformation(), null, "invokedLogicalTransformation", null, 1, 1, TransformationOccurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTransformationOccurrence_TimeCondition(), theTemporalconstraintPackage.getLogicalTimeCondition(), null, "timeCondition", null, 0, 1, TransformationOccurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	}
