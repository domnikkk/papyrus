...
public class SafetyrequirementPackageImpl extends EPackageImpl implements SafetyrequirementPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(functionalSafetyConceptEClass, FunctionalSafetyConcept.class, "FunctionalSafetyConcept", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getFunctionalSafetyConcept_FunctionalSafetyRequirement(), theRequirementsPackage_1.getRequirement(), null,
				"functionalSafetyRequirement", null, 0, -1, FunctionalSafetyConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(safetyGoalEClass, SafetyGoal.class, "SafetyGoal", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getSafetyGoal_DerivedFrom(), theDependabilityPackage.getHazardousEvent(), null,
				"derivedFrom", null, 1, -1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
		initEReference(getSafetyGoal_Base_Class(), theUMLPackage.getClass_(), null, "base_Class", null, 1, 1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
		initEReference(getSafetyGoal_Requirement(), theRequirementsPackage_1.getRequirement(), null,
				"requirement", null, 1, -1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getSafetyGoal_HazardClassification(), theSafetyconstraintsPackage.getASILKind(),
				"hazardClassification", null, 1, 1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
		initEReference(getSafetyGoal_SafeState(), theBehaviorPackage.getMode(), null,
				"safeState", null, 0, -1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$

		initEClass(technicalSafetyConceptEClass, TechnicalSafetyConcept.class, "TechnicalSafetyConcept", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getTechnicalSafetyConcept_TechnicalSafetyRequirement(), theRequirementsPackage_1.getRequirement(), null,
				"technicalSafetyRequirement", null, 0, -1, TechnicalSafetyConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
	...
	protected void createUMLAnnotations() {
		...
		addAnnotation(this,
				source,
				new String[] { "originalName", "SafetyRequirement" //$NON-NLS-1$ //$NON-NLS-2$
				});
	}
