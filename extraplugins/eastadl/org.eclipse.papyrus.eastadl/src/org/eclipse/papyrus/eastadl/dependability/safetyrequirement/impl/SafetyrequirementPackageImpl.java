...
public class SafetyrequirementPackageImpl extends EPackageImpl implements SafetyrequirementPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getFunctionalSafetyConcept_FunctionalSafetyRequirement(), theRequirementsPackage_1.getRequirement(), null, "functionalSafetyRequirement", null, 0, -1, FunctionalSafetyConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSafetyGoal_Requirement(), theRequirementsPackage_1.getRequirement(), null, "requirement", null, 1, -1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getSafetyGoal_SafeState(), theBehaviorPackage.getMode(), null, "safeState", null, 0, -1, SafetyGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTechnicalSafetyConcept_TechnicalSafetyRequirement(), theRequirementsPackage_1.getRequirement(), null, "technicalSafetyRequirement", null, 0, -1, TechnicalSafetyConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
