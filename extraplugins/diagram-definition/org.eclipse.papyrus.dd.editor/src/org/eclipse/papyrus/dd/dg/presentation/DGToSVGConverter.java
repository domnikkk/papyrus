...
public class DGToSVGConverter extends DGSwitch<Object> implements SVGSyntax {
	...
	public Object caseCanvas(Canvas object) {
		...
		if(svg == null) {
			svg = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_SVG_TAG));
		...
		if(object.getBounds() != null) {
			...
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__X))
				svg.setAttribute(SVG_X_ATTRIBUTE, convertDoubleToString(bounds.getX()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__Y))
				svg.setAttribute(SVG_Y_ATTRIBUTE, convertDoubleToString(bounds.getY()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__WIDTH))
				svg.setAttribute(SVG_WIDTH_ATTRIBUTE, convertDoubleToString(bounds.getWidth()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__HEIGHT))
				svg.setAttribute(SVG_HEIGHT_ATTRIBUTE, convertDoubleToString(bounds.getHeight()));
		}
	...
	public Object caseCircle(Circle object) {
		Element circle = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_CIRCLE_TAG));
		...
		if(object.getCenter() != null) {
			...
			if(center.eIsSet(DCPackage.Literals.POINT__X))
				circle.setAttribute(SVG_CX_ATTRIBUTE, convertDoubleToString(center.getX()));
			if(center.eIsSet(DCPackage.Literals.POINT__Y))
				circle.setAttribute(SVG_CY_ATTRIBUTE, convertDoubleToString(center.getY()));
		}
		circle.setAttribute(SVG_R_ATTRIBUTE, convertDoubleToString(object.getRadius()));
		return super.caseCircle(object);
	}

	@Override
	public Object caseClipPath(ClipPath object) {
		Element clipPath = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_CLIP_PATH_TAG));
		getParentElement(object).appendChild(clipPath);
		clipPath.setAttribute(SVG_CLIP_PATH_UNITS_ATTRIBUTE, SVG_OBJECT_BOUNDING_BOX_VALUE);
	...
	public Object caseCubicCurveTo(CubicCurveTo object) {
		...
		if(object.getStartControl() != null) {
			...
			sb.append(convertDoubleToString(start.getX()) + "," + convertDoubleToString(start.getY()));
		} else
			sb.append("0.0,0.0");
		sb.append(" ");
		if(object.getEndControl() != null) {
			Point end = object.getEndControl();
			sb.append(convertDoubleToString(end.getX()) + "," + convertDoubleToString(end.getY()));
		} else
			sb.append("0.0,0.0");
		sb.append(" ");
		if(object.getPoint() != null) {
			Point point = object.getPoint();
			sb.append(convertDoubleToString(point.getX()) + "," + convertDoubleToString(point.getY()));
		} else
			sb.append("0.0,0.0");
	...
	public Object caseDefinitions(Definitions object) {
		Element defs = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_DEFS_TAG));
	...
	public Object caseEllipse(Ellipse object) {
		Element ellipse = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_ELLIPSE_TAG));
		getParentElement(object).appendChild(ellipse);
		if(object.getCenter() != null) {
			Point center = object.getCenter();
			if(center.eIsSet(DCPackage.Literals.POINT__X))
				ellipse.setAttribute(SVG_CX_ATTRIBUTE, convertDoubleToString(center.getX()));
			if(center.eIsSet(DCPackage.Literals.POINT__Y))
				ellipse.setAttribute(SVG_CY_ATTRIBUTE, convertDoubleToString(center.getY()));
		}
		if(object.getRadii() != null) {
			Dimension radii = object.getRadii();
			ellipse.setAttribute(SVG_RX_ATTRIBUTE, convertDoubleToString(radii.getWidth()));
			ellipse.setAttribute(SVG_RY_ATTRIBUTE, convertDoubleToString(radii.getHeight()));
		} else {
	...
	public Object caseEllipticalArcTo(EllipticalArcTo object) {
		...
		if(object.getRadii() != null) {
			Dimension radii = object.getRadii();
			sb.append(convertDoubleToString(radii.getWidth()) + "," + convertDoubleToString(radii.getHeight()));
		} else
			sb.append("0.0,0.0");
		sb.append(" ");
	...
	public Object caseGradient(Gradient object) {
		...
		if(gradient != null) {
			if(object.getTransforms().size() > 0) {
				...
				gradient.setAttribute(SVG_GRADIENT_TRANSFORM_ATTRIBUTE, transforms);
			}
		}
	...
	public Object caseGradientStop(GradientStop object) {
		Element stop = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_STOP_TAG));
		getParentElement(object).appendChild(stop);
		if(object.eIsSet(DGPackage.Literals.GRADIENT_STOP__OFFSET))
			stop.setAttribute(SVG_OFFSET_ATTRIBUTE, convertDoubleToString(object.getOffset()) + "%");
		if(object.eIsSet(DGPackage.Literals.GRADIENT_STOP__COLOR))
			stop.setAttribute(SVG_STOP_COLOR_ATTRIBUTE, convertColorToString(object.getColor()));
		if(object.eIsSet(DGPackage.Literals.GRADIENT_STOP__OPACITY))
			stop.setAttribute(SVG_STOP_OPACITY_ATTRIBUTE, convertDoubleToString(object.getOpacity()));
	...
	public Object caseGraphicalElement(GraphicalElement object) {
		...
		if(element != null) {
			...
			if(object.getClipPath() != null) {
				element.setAttribute(SVG_CLIP_PATH_ATTRIBUTE, convertReferenceToURL(object.getClipPath()));
			}
			if(object.getTransforms().size() > 0) {
				String transforms = "";
				for(Transform transform : object.getTransforms()) {
	...
	public Object caseGroup(Group object) {
		...
		if(g == null) {
			g = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_G_TAG));
	...
	public Object caseImage(Image object) {
		Element image = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_IMAGE_TAG));
		getParentElement(object).appendChild(image);
		if(object.getBounds() != null) {
			Bounds bounds = object.getBounds();
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__X))
				image.setAttribute(SVG_X_ATTRIBUTE, convertDoubleToString(bounds.getX()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__Y))
				image.setAttribute(SVG_Y_ATTRIBUTE, convertDoubleToString(bounds.getY()));
			image.setAttribute(SVG_WIDTH_ATTRIBUTE, convertDoubleToString(bounds.getWidth()));
			image.setAttribute(SVG_HEIGHT_ATTRIBUTE, convertDoubleToString(bounds.getHeight()));
		} else {
		...
		if(object.getSource() != null && object.getSource().length() > 0)
			image.setAttributeNS(XLINK_NAMESPACE_URI, XLINK_HREF_QNAME, object.getSource());
		else
			image.setAttributeNS(XLINK_NAMESPACE_URI, XLINK_HREF_QNAME, "http://missing.reference");
	...
	public Object caseLine(Line object) {
		Element line = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_LINE_TAG));
		...
		if(object.getStart() != null) {
			...
			if(start.eIsSet(DCPackage.Literals.POINT__X))
				line.setAttribute(SVG_X1_ATTRIBUTE, convertDoubleToString(start.getX()));
			if(start.eIsSet(DCPackage.Literals.POINT__Y))
				line.setAttribute(SVG_Y1_ATTRIBUTE, convertDoubleToString(start.getY()));
		}
		if(object.getEnd() != null) {
			Point end = object.getEnd();
			if(end.eIsSet(DCPackage.Literals.POINT__X))
				line.setAttribute(SVG_X2_ATTRIBUTE, convertDoubleToString(end.getX()));
			if(end.eIsSet(DCPackage.Literals.POINT__Y))
				line.setAttribute(SVG_Y2_ATTRIBUTE, convertDoubleToString(end.getY()));
		}
	...
	public Object caseLinearGradient(LinearGradient object) {
		Element gradient = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_LINEAR_GRADIENT_TAG));
		getParentElement(object).appendChild(gradient);
		gradient.setAttribute(SVG_GRADIENT_UNITS_ATTRIBUTE, SVG_OBJECT_BOUNDING_BOX_VALUE);
		if(object.getStart() != null) {
			Point start = object.getStart();
			if(start.eIsSet(DCPackage.Literals.POINT__X))
				gradient.setAttribute(SVG_X1_ATTRIBUTE, convertDoubleToString(start.getX()) + "%");
			if(start.eIsSet(DCPackage.Literals.POINT__Y))
				gradient.setAttribute(SVG_Y1_ATTRIBUTE, convertDoubleToString(start.getY()) + "%");
		}
		if(object.getEnd() != null) {
			Point end = object.getEnd();
			if(end.eIsSet(DCPackage.Literals.POINT__X))
				gradient.setAttribute(SVG_X2_ATTRIBUTE, convertDoubleToString(end.getX()) + "%");
			if(end.eIsSet(DCPackage.Literals.POINT__Y))
				gradient.setAttribute(SVG_Y2_ATTRIBUTE, convertDoubleToString(end.getY()) + "%");
		}
	...
	public Object caseMarkedElement(MarkedElement object) {
		...
		if(element != null) {
			if(object.getStartMarker() != null)
				element.setAttribute(SVG_MARKER_START_ATTRIBUTE, convertReferenceToURL(object.getStartMarker()));
			if(object.getMidMarker() != null)
				element.setAttribute(SVG_MARKER_MID_ATTRIBUTE, convertReferenceToURL(object.getMidMarker()));
			if(object.getEndMarker() != null)
				element.setAttribute(SVG_MARKER_END_ATTRIBUTE, convertReferenceToURL(object.getEndMarker()));
		}
	...
	public Object caseMarker(Marker object) {
		Element marker = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_MARKER_TAG));
		...
		if(object.getSize() != null) {
			...
			if(size.eIsSet(DCPackage.Literals.DIMENSION__WIDTH))
				marker.setAttribute(SVG_MARKER_WIDTH_ATTRIBUTE, convertDoubleToString(size.getWidth()));
			if(size.eIsSet(DCPackage.Literals.DIMENSION__HEIGHT))
				marker.setAttribute(SVG_MARKER_HEIGHT_ATTRIBUTE, convertDoubleToString(size.getHeight()));
		}
		if(object.getReference() != null) {
			Point reference = object.getReference();
			if(reference.eIsSet(DCPackage.Literals.POINT__X))
				marker.setAttribute(SVG_REF_X_ATTRIBUTE, convertDoubleToString(reference.getX()));
			if(reference.eIsSet(DCPackage.Literals.POINT__Y))
				marker.setAttribute(SVG_REF_Y_ATTRIBUTE, convertDoubleToString(reference.getY()));
		}
	...
	public Object casePath(Path object) {
		Element path = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_PATH_TAG));
	...
	public Object casePattern(Pattern object) {
		Element pattern = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_PATTERN_TAG));
		getParentElement(object).appendChild(pattern);
		pattern.setAttribute(SVG_PATTERN_UNITS_ATTRIBUTE, SVG_OBJECT_BOUNDING_BOX_VALUE);
		if(object.getBounds() != null) {
			Bounds bounds = object.getBounds();
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__X))
				pattern.setAttribute(SVG_X_ATTRIBUTE, convertDoubleToString(bounds.getX()) + "%");
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__Y))
				pattern.setAttribute(SVG_Y_ATTRIBUTE, convertDoubleToString(bounds.getY()) + "%");
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__WIDTH))
				pattern.setAttribute(SVG_WIDTH_ATTRIBUTE, convertDoubleToString(bounds.getWidth()) + "%");
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__HEIGHT))
				pattern.setAttribute(SVG_HEIGHT_ATTRIBUTE, convertDoubleToString(bounds.getHeight()) + "%");
		}
		if(object.getTransforms().size() > 0) {
			String transforms = "";
			for(Transform transform : object.getTransforms()) {
	...
	public Object casePolygon(Polygon object) {
		Element polygon = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_POLYGON_TAG));
	...
	public Object casePolyline(Polyline object) {
		Element polyline = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_POLYLINE_TAG));
	...
	public Object caseRadialGradient(RadialGradient object) {
		Element gradient = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_RADIAL_GRADIENT_TAG));
		getParentElement(object).appendChild(gradient);
		gradient.setAttribute(SVG_GRADIENT_UNITS_ATTRIBUTE, SVG_OBJECT_BOUNDING_BOX_VALUE);
		if(object.eIsSet(DGPackage.Literals.RADIAL_GRADIENT__RADIUS)) {
			gradient.setAttribute(SVG_R_ATTRIBUTE, convertDoubleToString(object.getRadius()) + "%");
		}
		if(object.getCenter() != null) {
			Point center = object.getCenter();
			if(center.eIsSet(DCPackage.Literals.POINT__X))
				gradient.setAttribute(SVG_CX_ATTRIBUTE, convertDoubleToString(center.getX()) + "%");
			if(center.eIsSet(DCPackage.Literals.POINT__Y))
				gradient.setAttribute(SVG_CY_ATTRIBUTE, convertDoubleToString(center.getY()) + "%");
		}
		if(object.getFocus() != null) {
			Point focus = object.getFocus();
			if(focus.eIsSet(DCPackage.Literals.POINT__X))
				gradient.setAttribute(SVG_FX_ATTRIBUTE, convertDoubleToString(focus.getX()) + "%");
			if(focus.eIsSet(DCPackage.Literals.POINT__Y))
				gradient.setAttribute(SVG_FY_ATTRIBUTE, convertDoubleToString(focus.getY()) + "%");
		}
	...
	public Object caseRectangle(Rectangle object) {
		Element rect = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_RECT_TAG));
		getParentElement(object).appendChild(rect);
		if(object.getBounds() != null) {
			Bounds bounds = object.getBounds();
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__X))
				rect.setAttribute(SVG_X_ATTRIBUTE, convertDoubleToString(bounds.getX()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__Y))
				rect.setAttribute(SVG_Y_ATTRIBUTE, convertDoubleToString(bounds.getY()));
			rect.setAttribute(SVG_WIDTH_ATTRIBUTE, convertDoubleToString(bounds.getWidth()));
			rect.setAttribute(SVG_HEIGHT_ATTRIBUTE, convertDoubleToString(bounds.getHeight()));
		} else {
		...
		if(object.eIsSet(DGPackage.Literals.RECTANGLE__CORNER_RADIUS)) {
			rect.setAttribute(SVG_RX_ATTRIBUTE, convertDoubleToString(object.getCornerRadius()));
			rect.setAttribute(SVG_RY_ATTRIBUTE, convertDoubleToString(object.getCornerRadius()));
		}
	...
	public Object caseRootCanvas(RootCanvas object) {
		...
		for(StyleSheet styleSheet : object.getExternalStyleSheets()) {
			...
			ProcessingInstruction pi = svgDocument.createProcessingInstruction(target, data);
	...
	public Object caseStyle(Style object) {
		...
		if(object.eIsSet(DGPackage.Literals.STYLE__FILL)) {
			String value = (object.getFill() == null) ? "none" : (String)doSwitch(object.getFill());
		...
		if(object.eIsSet(DGPackage.Literals.STYLE__STROKE)) {
			String value = (object.getStroke() == null) ? "none" : (String)doSwitch(object.getStroke());
	...
	public Object caseStyleSheet(StyleSheet object) {
		Element styleSheet = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_STYLE_TAG));
	...
	public Object caseText(Text object) {
		...
		if(object.getBounds() != null) {
			Bounds bounds = object.getBounds();
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__X))
				text.setAttribute(SVG_X_ATTRIBUTE, convertDoubleToString(bounds.getX()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__Y))
				text.setAttribute(SVG_Y_ATTRIBUTE, convertDoubleToString(bounds.getY()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__WIDTH))
				text.setAttribute(SVG_WIDTH_ATTRIBUTE, convertDoubleToString(bounds.getWidth()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__HEIGHT))
				text.setAttribute(SVG_HEIGHT_ATTRIBUTE, convertDoubleToString(bounds.getHeight()));
		}
	...
	public Object caseUse(Use object) {
		Element use = map(object, svgDocument.createElementNS(SVG_NAMESPACE_URI, SVG_USE_TAG));
		getParentElement(object).appendChild(use);
		if(object.getReferencedElement() != null) {
			use.setAttributeNS(XLINK_NAMESPACE_URI, XLINK_HREF_QNAME, convertReferenceToURI(object.getReferencedElement()));
		}
		if(object.getBounds() != null) {
			Bounds bounds = object.getBounds();
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__X))
				use.setAttribute(SVG_X_ATTRIBUTE, convertDoubleToString(bounds.getX()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__Y))
				use.setAttribute(SVG_Y_ATTRIBUTE, convertDoubleToString(bounds.getY()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__WIDTH))
				use.setAttribute(SVG_WIDTH_ATTRIBUTE, convertDoubleToString(bounds.getWidth()));
			if(bounds.eIsSet(DCPackage.Literals.BOUNDS__HEIGHT))
				use.setAttribute(SVG_HEIGHT_ATTRIBUTE, convertDoubleToString(bounds.getHeight()));
		}
