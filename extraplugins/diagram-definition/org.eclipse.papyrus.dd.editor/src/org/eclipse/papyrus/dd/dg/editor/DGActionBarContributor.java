 ...
 */
public class DGActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction refreshViewerAction = new Action(
			DDEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				DDEditorPlugin.INSTANCE.getString("_UI_DGEditor_menu"),
				"org.eclipse.papyrus.dd.dgMenuID");
