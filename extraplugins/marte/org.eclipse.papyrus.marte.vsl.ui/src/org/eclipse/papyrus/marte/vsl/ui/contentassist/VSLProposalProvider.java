						...
						for (String s : allProposals.keySet()) {
							if (s.startsWith(context.getPrefix())) {
								...
								if (allProposals.get(s) == null) {
									...
									completionProposal = CompletionProposalUtils.createCompletionProposalWithReplacementOfPrefix(((allProposals.get(s) != null) && (allProposals.get(s) instanceof NamedElement)) ? (NamedElement) allProposals.get(s) : null,
						...
						for (String s : allProposals.keySet()) {
							if (s.startsWith(context.getPrefix())) {
								...
								if (allProposals.get(s) == null) {
									...
									completionProposal = CompletionProposalUtils.createCompletionProposalWithReplacementOfPrefix(
											((allProposals.get(s) != null) && (allProposals.get(s) instanceof NamedElement)) ? ((allProposals.get(s) != null) && (allProposals.get(s) instanceof NamedElement)) ? (NamedElement) allProposals.get(s) : null : null,
											completionString, displayString, context);
								}
								acceptor.accept(completionProposal);
							}
		...
		if (classifierForScoping != null) {
			for (Feature f : classifierForScoping.allFeatures()) {
				if (f instanceof Operation) {
					...
					if (o.getType() != null
							&& !(o.getName().equals("<") || o.getName().equals(">") || o.getName().equals("<=") || o.getName().equals(">=") || o.getName().equals("==") || o.getName().equals("<>") || o.getName().equals("+") || o.getName().equals("-")
									|| o.getName().equals("*") || o.getName().equals("/") || o.getName().equals("^"))) {
						allOperations.add(o);
					}
				}
			}
		...
		for (String s : allProposals.keySet()) {
			if (s.startsWith(context.getPrefix())) {
				...
				if (allProposals.get(s) == null) {
					...
					completionProposal = CompletionProposalUtils.createCompletionProposalWithReplacementOfPrefix(((allProposals.get(s) != null) && (allProposals.get(s) instanceof NamedElement)) ? (NamedElement) allProposals.get(s) : null, completionString,
