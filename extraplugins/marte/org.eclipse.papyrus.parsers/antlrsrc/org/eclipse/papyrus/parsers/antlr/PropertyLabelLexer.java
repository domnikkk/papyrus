...
public class PropertyLabelLexer extends Lexer {
	...
	public void mTokens() throws RecognitionException {
		// D:\\Workspaces\\Papyrus_Branch_0.7\\org.eclipse.papyrus.parsers_TRUNK\\resources\\grammars\\PropertyLabel.g:1:8: ( T__55 | T__56 | T__57 | T__58 | T__59 | T__60 | T__61 | T__62 | NL | WS | QUESTION_MARK | LNOT | DOUBLE_QUOTE | SINGLE_QUOTE | LPAREN
		// | RPAREN | LSQUARE | RSQUARE | LCURLY | DOUBLE_LCURLY | RCURLY | DOUBLE_RCURLY | LOGICAL_AND | DOUBLE_LOGICAL_AND | PIPE | DOUBLE_PIPE | POINT | RANGE | COMMA | SEMI | SHARP | TILDE | COLON | FOUR_POINTS | RULE_ASSIGN | ARROW | STAR | DIV | PLUS |
		// MINUS | EQ | ISEQ | ISNE | LT | DOUBLE_LT | LE | GT | DOUBLE_GT | GE | INCR | DECR | CALLOPERATION | UNDERSCORE | RANGE_VALUE | REAL | INTEGER | IDENTIFIER )
		int alt7 = 57;
	...
	class DFA4 extends DFA {
		...
		public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
			...
			case 1:
				...
				input.rewind();
				s = -1;
				if ((LA4_3 == '.') && (synpred1_PropertyLabel())) {
					s = 4;
				}

				else if (((LA4_3 >= '0' && LA4_3 <= '9')) && (synpred2_PropertyLabel())) {
					s = 5;
				}
