...
public class HwStorageManagerPackageImpl extends EPackageImpl implements HwStorageManagerPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link HwStorageManagerPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #eNS_URI
	...
	public static HwStorageManagerPackage init() {
		if (isInited) {
			return (HwStorageManagerPackage) EPackage.Registry.INSTANCE.getEPackage(HwStorageManagerPackage.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getHwStorageManager_ManagedMemories(), theHwMemoryPackage.getHwMemory(), null, "managedMemories", null, 0, -1, HwStorageManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
	...
	protected void createSubsetsAnnotations() {
		...
		addAnnotation(getHwMMU_OwnedTLBs(),
				source,
				new String[] {
				},
				new URI[] {
