...
public class HwMemorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HwMemoryPackage.HW_MEMORY: {
			...
			if (result == null) {
				result = caseHwResource(hwMemory);
			}
			if (result == null) {
				result = caseStorageResource(hwMemory);
			}
			if (result == null) {
				result = caseResource(hwMemory);
			}
			if (result == null) {
		...
		case HwMemoryPackage.HW_RAM: {
			...
			if (result == null) {
				result = caseHwMemory(hwRAM);
			}
			if (result == null) {
				result = caseHwResource(hwRAM);
			}
			if (result == null) {
				result = caseStorageResource(hwRAM);
			}
			if (result == null) {
				result = caseResource(hwRAM);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case HwMemoryPackage.HW_ROM: {
			...
			if (result == null) {
				result = caseHwMemory(hwROM);
			}
			if (result == null) {
				result = caseHwResource(hwROM);
			}
			if (result == null) {
				result = caseStorageResource(hwROM);
			}
			if (result == null) {
				result = caseResource(hwROM);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case HwMemoryPackage.HW_DRIVE: {
			...
			if (result == null) {
				result = caseHwMemory(hwDrive);
			}
			if (result == null) {
				result = caseHwResource(hwDrive);
			}
			if (result == null) {
				result = caseStorageResource(hwDrive);
			}
			if (result == null) {
				result = caseResource(hwDrive);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case HwMemoryPackage.HW_CACHE: {
			...
			if (result == null) {
				result = caseHwMemory(hwCache);
			}
			if (result == null) {
				result = caseHwResource(hwCache);
			}
			if (result == null) {
				result = caseStorageResource(hwCache);
			}
			if (result == null) {
				result = caseResource(hwCache);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
