...
public class HwGeneralPackageImpl extends EPackageImpl implements HwGeneralPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link HwGeneralPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #eNS_URI
	...
	public static HwGeneralPackage init() {
		if (isInited) {
			return (HwGeneralPackage) EPackage.Registry.INSTANCE.getEPackage(HwGeneralPackage.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getHwResource_P_HW_Services(), this.getHwResourceService(), null, "p_HW_Services", null, 0, -1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getHwResource_R_HW_Services(), this.getHwResourceService(), null, "r_HW_Services", null, 0, -1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEReference(getHwResource_EndPoints(), theHwCommunicationPackage.getHwEndPoint(), null, "endPoints", null, 0, -1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
	...
	protected void createSubsetsAnnotations() {
		...
		addAnnotation(getHwResource_EndPoints(),
				source,
				new String[] {
				},
				new URI[] {
