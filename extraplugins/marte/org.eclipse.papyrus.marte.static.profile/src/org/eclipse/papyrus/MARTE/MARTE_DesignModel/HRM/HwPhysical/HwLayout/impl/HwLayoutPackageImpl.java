...
public class HwLayoutPackageImpl extends EPackageImpl implements HwLayoutPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link HwLayoutPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #eNS_URI
	...
	public static HwLayoutPackage init() {
		if (isInited) {
			return (HwLayoutPackage) EPackage.Registry.INSTANCE.getEPackage(HwLayoutPackage.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getHwComponent_PoweredServices(), theHwGeneralPackage.getHwResourceService(), null, "poweredServices", null, 0, -1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
		...
		initEReference(getHwComponent_SubComponents(), this.getHwComponent(), null, "subComponents", null, 0, -1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
	...
	protected void createSubsetsAnnotations() {
		...
		addAnnotation(getHwComponent_SubComponents(),
				source,
				new String[] {
				},
				new URI[] {
