...
public class HwComputingPackageImpl extends EPackageImpl implements HwComputingPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link HwComputingPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #eNS_URI
	...
	public static HwComputingPackage init() {
		if (isInited) {
			return (HwComputingPackage) EPackage.Registry.INSTANCE.getEPackage(HwComputingPackage.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getHwProcessor_Predictors(), this.getHwBranchPredictor(), null, "predictors", null, 0, -1, HwProcessor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEReference(getHwProcessor_OwnedMMUs(), theHwStorageManagerPackage.getHwMMU(), null, "ownedMMUs", null, 0, -1, HwProcessor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEAttribute(getHwComputingResource_Op_Frequencies(), theMARTE_DataTypesPackage.getNFP_FrequencyInterval(), "op_Frequencies", null, 0, 1, HwComputingResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
		...
		initEReference(getHwPLD_BlocksComputing(), this.getHwComputingResource(), null, "blocksComputing", null, 0, -1, HwPLD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
	...
	protected void createSubsetsAnnotations() {
		...
		addAnnotation(getHwProcessor_OwnedISAs(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getHwProcessor_Predictors(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getHwProcessor_Caches(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getHwProcessor_OwnedMMUs(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getHwPLD_BlocksRAM(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getHwPLD_BlocksComputing(),
				source,
				new String[] {
				},
				new URI[] {
