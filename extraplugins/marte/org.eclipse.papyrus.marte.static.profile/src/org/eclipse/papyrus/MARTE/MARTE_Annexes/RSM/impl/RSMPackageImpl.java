...
public class RSMPackageImpl extends EPackageImpl implements RSMPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link RSMPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #eNS_URI
	...
	public static RSMPackage init() {
		if (isInited) {
			return (RSMPackage) EPackage.Registry.INSTANCE.getEPackage(RSMPackage.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getLinkTopology_Base_Connector(), theUMLPackage.getConnector(), null, "base_Connector", null, 1, 1, LinkTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE,
		...
		initEAttribute(getInterRepetition_RepetitionShapeDependence(), theMARTE_DataTypesPackage.getIntegerVector(), "repetitionShapeDependence", null, 1, 1, InterRepetition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		...
		initEReference(getTiler_Base_ConnectorEnd(), theUMLPackage.getConnectorEnd(), null, "base_ConnectorEnd", null, 1, 1, Tiler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEReference(getShaped_Base_MultiplicityElement(), theUMLPackage.getMultiplicityElement(), null, "base_MultiplicityElement", null, 1, 1, Shaped.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				!IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	}
