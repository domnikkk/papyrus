...
public class NFPsPackageImpl extends EPackageImpl implements NFPsPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link NFPsPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #eNS_URI
	...
	public static NFPsPackage init() {
		if (isInited) {
			return (NFPsPackage) EPackage.Registry.INSTANCE.getEPackage(NFPsPackage.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getUnit_Base_EnumerationLiteral(), theUMLPackage.getEnumerationLiteral(), null, "base_EnumerationLiteral", null, 1, 1, Unit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
		...
		initEReference(getNfpConstraint_Base_Constraint(), theUMLPackage.getConstraint(), null, "base_Constraint", null, 1, 1, NfpConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getNfpConstraint_Mode(), theCoreElementsPackage.getMode(), null, "mode", null, 0, -1, NfpConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEReference(getDimension_Base_Enumeration(), theUMLPackage.getEnumeration(), null, "base_Enumeration", null, 1, 1, Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
	...
	protected void createSubsetsAnnotations() {
		...
		addAnnotation(getNfpType_ValueAttrib(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getNfpType_UnitAttrib(),
				source,
				new String[] {
				},
				new URI[] {
		...
		addAnnotation(getNfpType_ExprAttrib(),
				source,
				new String[] {
				},
				new URI[] {
