...
public class HwDeviceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HwDevicePackage.HW_DEVICE: {
			...
			if (result == null) {
				result = caseHwResource(hwDevice);
			}
			if (result == null) {
				result = caseDeviceResource(hwDevice);
			}
			if (result == null) {
				result = caseProcessingResource(hwDevice);
			}
			if (result == null) {
				result = caseResource(hwDevice);
			}
			if (result == null) {
		...
		case HwDevicePackage.HW_IO: {
			...
			if (result == null) {
				result = caseHwDevice(hwI_O);
			}
			if (result == null) {
				result = caseHwResource(hwI_O);
			}
			if (result == null) {
				result = caseDeviceResource(hwI_O);
			}
			if (result == null) {
				result = caseProcessingResource(hwI_O);
			}
			if (result == null) {
				result = caseResource(hwI_O);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case HwDevicePackage.HW_SUPPORT: {
			...
			if (result == null) {
				result = caseHwDevice(hwSupport);
			}
			if (result == null) {
				result = caseHwResource(hwSupport);
			}
			if (result == null) {
				result = caseDeviceResource(hwSupport);
			}
			if (result == null) {
				result = caseProcessingResource(hwSupport);
			}
			if (result == null) {
				result = caseResource(hwSupport);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case HwDevicePackage.HW_ACTUATOR: {
			...
			if (result == null) {
				result = caseHwI_O(hwActuator);
			}
			if (result == null) {
				result = caseHwDevice(hwActuator);
			}
			if (result == null) {
				result = caseHwResource(hwActuator);
			}
			if (result == null) {
				result = caseDeviceResource(hwActuator);
			}
			if (result == null) {
				result = caseProcessingResource(hwActuator);
			}
			if (result == null) {
				result = caseResource(hwActuator);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case HwDevicePackage.HW_SENSOR: {
			...
			if (result == null) {
				result = caseHwI_O(hwSensor);
			}
			if (result == null) {
				result = caseHwDevice(hwSensor);
			}
			if (result == null) {
				result = caseHwResource(hwSensor);
			}
			if (result == null) {
				result = caseDeviceResource(hwSensor);
			}
			if (result == null) {
				result = caseProcessingResource(hwSensor);
			}
			if (result == null) {
				result = caseResource(hwSensor);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
