...
public class MARTE_PrimitivesTypesPackageImpl extends EPackageImpl implements MARTE_PrimitivesTypesPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link MARTE_PrimitivesTypesPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #eNS_URI
	...
	public static MARTE_PrimitivesTypesPackage init() {
		if (isInited) {
			return (MARTE_PrimitivesTypesPackage) EPackage.Registry.INSTANCE.getEPackage(MARTE_PrimitivesTypesPackage.eNS_URI);
		}

		// Obtain or create and register package
		MARTE_PrimitivesTypesPackageImpl theMARTE_PrimitivesTypesPackage = (MARTE_PrimitivesTypesPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MARTE_PrimitivesTypesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
				: new MARTE_PrimitivesTypesPackageImpl());
