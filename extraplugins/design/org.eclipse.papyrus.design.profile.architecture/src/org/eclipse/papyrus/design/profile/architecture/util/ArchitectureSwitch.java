...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ArchitecturePackage.LAYER_DEPENDENCY: {
			...
			if (result == null) {
				result = caseElement(layerDependency);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case ArchitecturePackage.PLUGIN: {
			...
			if (result == null) {
				result = caseProject(plugin);
			}
			if (result == null) {
				result = caseElement(plugin);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case ArchitecturePackage.PROJECT_DEPENDENCY: {
			...
			if (result == null) {
				result = caseElement(projectDependency);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
