...
import org.eclipse.papyrus.migration.rsa.RSAToPapyrusParameters.util.RSAToPapyrusParametersAdapterFactory;
...
public class RSAToPapyrusParametersItemProviderAdapterFactory extends RSAToPapyrusParametersAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	public Adapter createURIMappingAdapter() {
		if (uriMappingItemProvider == null) {
			uriMappingItemProvider = new URIMappingItemProvider(this);
		}

		return uriMappingItemProvider;
	}
