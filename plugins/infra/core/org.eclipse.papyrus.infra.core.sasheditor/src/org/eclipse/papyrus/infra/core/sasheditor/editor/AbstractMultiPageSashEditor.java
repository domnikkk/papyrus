...
public abstract class AbstractMultiPageSashEditor extends EditorPart implements IMultiPageEditorPart, IMultiEditorManager {
	 ...
	 */
	private IPageLifeCycleEventsListener2 pageLifeCycleEventListener = new DefautPageLifeCycleEventListener() {
		 ...
		 * 
		 * @see org.eclipse.papyrus.infra.core.sasheditor.editor.DefautPageLifeCycleEventListener#pageChanged(org.eclipse.papyrus.infra.core.sasheditor.editor.IPage)
		 *
		 * @param newPage
		 */
