...
public class AvailabilityUpdater {
	...
	private static class VerifyUpdateSiteJob implements
		...
		public VerifyUpdateSiteJob call() throws Exception {
			...
			for (String location : new String[] { "compositeContent.jar", "content.jar", "content.xml", "site.xml","compositeContent.xml" }) { //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4//$NON-NLS-5
