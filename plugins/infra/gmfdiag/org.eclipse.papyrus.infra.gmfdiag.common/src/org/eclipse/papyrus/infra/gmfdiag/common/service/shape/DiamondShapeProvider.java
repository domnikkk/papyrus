...
/**
 * The Class DiamondShapeProvider.
 */
public abstract class DiamondShapeProvider extends AbstractShapeProvider {


	/** The Constant SYMBOL_SVG_PATH. */
	private static final String SYMBOL_SVG_PATH = "/icons/symbols/diamond.svg";
	...
	/**
	 * The Class ShapeProviderNotificationManager.
	 */
	public class ShapeProviderNotificationManager extends ProviderNotificationManager implements NotificationListener {

		/**
		 * Instantiates a new shape provider notification manager.
		 *
		 * @param diagramEventBroker
		 *            the diagram event broker
		 * @param view
		 *            the view
		 * @param listener
		 *            the listener
		...
		/**
		 * @see org.eclipse.papyrus.infra.gmfdiag.common.service.shape.ProviderNotificationManager#registerListeners()
		 *
		 */
		@Override
		...
		/**
		 * @see org.eclipse.papyrus.infra.gmfdiag.common.service.shape.ProviderNotificationManager#dispose()
		 *
		 */
		@Override
		public void dispose() {
