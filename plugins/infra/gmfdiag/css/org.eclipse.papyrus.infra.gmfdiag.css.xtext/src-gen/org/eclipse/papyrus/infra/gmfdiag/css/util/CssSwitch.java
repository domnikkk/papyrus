...
public class CssSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		case CssPackage.COMPOSITE_SELECTOR: {
			...
			if (result == null) {
				result = caseSelector(compositeSelector);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case CssPackage.SIMPLE_SELECTOR: {
			...
			if (result == null) {
				result = caseSelector(simpleSelector);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case CssPackage.CLASS: {
			...
			if (result == null) {
				result = caseSelectorCondition(class_);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case CssPackage.ATTRIBUTE: {
			...
			if (result == null) {
				result = caseSelectorCondition(attribute);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case CssPackage.PSEUDO: {
			...
			if (result == null) {
				result = caseSelectorCondition(pseudo);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case CssPackage.CSS_ID: {
			...
			if (result == null) {
				result = caseSelectorCondition(cssId);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
