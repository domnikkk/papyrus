...
public class CSSSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		...
		match_Page___SemicolonKeyword_7_0_WSTerminalRuleCall_7_1_a__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getPageAccess().getSemicolonKeyword_7_0()), new TokenAlias(true, true, grammarAccess.getPageAccess()
				.getWSTerminalRuleCall_7_1()));
		match_Page___SemicolonKeyword_7_0_WSTerminalRuleCall_7_1_a__p = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getPageAccess().getSemicolonKeyword_7_0()), new TokenAlias(true, true, grammarAccess.getPageAccess()
				.getWSTerminalRuleCall_7_1()));
		...
		match_Ruleset___SemicolonKeyword_5_0_WSTerminalRuleCall_5_1_a__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getRulesetAccess().getSemicolonKeyword_5_0()), new TokenAlias(true, true, grammarAccess.getRulesetAccess()
				.getWSTerminalRuleCall_5_1()));
		match_Ruleset___SemicolonKeyword_5_0_WSTerminalRuleCall_5_1_a__p = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getRulesetAccess().getSemicolonKeyword_5_0()), new TokenAlias(true, true, grammarAccess.getRulesetAccess()
				.getWSTerminalRuleCall_5_1()));
		...
		match_Stylesheet___CDCTerminalRuleCall_1_2_or_CDOTerminalRuleCall_1_1_or_WSTerminalRuleCall_1_0__a = new AlternativeAlias(true, true, new TokenAlias(false, false, grammarAccess.getStylesheetAccess().getCDCTerminalRuleCall_1_2()), new TokenAlias(false,
				false, grammarAccess.getStylesheetAccess().getCDOTerminalRuleCall_1_1()), new TokenAlias(false, false, grammarAccess.getStylesheetAccess().getWSTerminalRuleCall_1_0()));
		match_Stylesheet___CDCTerminalRuleCall_1_2_or_CDOTerminalRuleCall_1_1_or_WSTerminalRuleCall_1_0__p = new AlternativeAlias(true, false, new TokenAlias(false, false, grammarAccess.getStylesheetAccess().getCDCTerminalRuleCall_1_2()), new TokenAlias(
				false, false, grammarAccess.getStylesheetAccess().getCDOTerminalRuleCall_1_1()), new TokenAlias(false, false, grammarAccess.getStylesheetAccess().getWSTerminalRuleCall_1_0()));
		match_Stylesheet_____CDCTerminalRuleCall_2_1_1_0_WSTerminalRuleCall_2_1_1_1_a___or___CDOTerminalRuleCall_2_1_0_0_WSTerminalRuleCall_2_1_0_1_a____a = new AlternativeAlias(true, true, new GroupAlias(false, false, new TokenAlias(false, false,
				grammarAccess.getStylesheetAccess().getCDCTerminalRuleCall_2_1_1_0()), new TokenAlias(true, true, grammarAccess.getStylesheetAccess().getWSTerminalRuleCall_2_1_1_1())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess
		...
		match_Stylesheet_____CDCTerminalRuleCall_3_1_1_0_WSTerminalRuleCall_3_1_1_1_a___or___CDOTerminalRuleCall_3_1_0_0_WSTerminalRuleCall_3_1_0_1_a____a = new AlternativeAlias(true, true, new GroupAlias(false, false, new TokenAlias(false, false,
				grammarAccess.getStylesheetAccess().getCDCTerminalRuleCall_3_1_1_0()), new TokenAlias(true, true, grammarAccess.getStylesheetAccess().getWSTerminalRuleCall_3_1_1_1())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess
