...
public class NewchildSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case NewchildPackage.MENU_ROOT: {
			...
			if (result == null) {
				result = caseMenuContainer(menuRoot);
			}
			if (result == null) {
				result = caseDisplayUnit(menuRoot);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case NewchildPackage.MENU_GROUP: {
			...
			if (result == null) {
				result = caseMenuContainer(menuGroup);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case NewchildPackage.CUSTOM_FILLER: {
			...
			if (result == null) {
				result = caseMenuItem(customFiller);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
