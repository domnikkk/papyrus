 ...
 *
 *****************************************************************************/
package org.eclipse.papyrus.diagram.usecase.command;
 ...
 * TODO Refactor to eop.diagram.common : this in a RestoreRelatedLinksCommand<T> class in eop.diagram.common
...
public class RestoreRelatedLinksCommand extends AbstractTransactionalCommand {
	...
	protected void createRelatedLinks(Collection<? extends UMLLinkDescriptor> linkDescriptors, Map<EObject, View> domain2NotationMap) {
		...
		for(UMLLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(nextLinkDescriptor.getSemanticAdapter(), null, ViewUtil.APPEND, true, host.getDiagramPreferencesHint());
