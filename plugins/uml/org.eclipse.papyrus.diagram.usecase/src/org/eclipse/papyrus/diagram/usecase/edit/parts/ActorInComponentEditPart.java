...
import org.eclipse.papyrus.diagram.usecase.edit.policies.ActorInComponentItemSemanticEditPolicy;
...
public class ActorInComponentEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActorInComponentItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ActorInComponentNameEditPart || borderItemEditPart instanceof ActorInComponentAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.usecase.edit.parts.ActorInComponentEditPart) {
			types.add(UMLElementTypes.Generalization_4010);
		}
