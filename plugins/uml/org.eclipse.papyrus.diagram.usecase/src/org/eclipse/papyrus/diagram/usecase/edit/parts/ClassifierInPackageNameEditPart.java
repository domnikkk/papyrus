 ...
 * @generated
 */
public class ClassifierInPackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassifierInPackageNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Classifier_3019, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.usecase.edit.parts.ClassifierInPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
