 ...
 * @generated
 */
public class ClassifierInPackagePreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public ClassifierInPackagePreferencePage() {
		super();
		setPreferenceKey(UseCaseDiagramEditPart.MODEL_ID + "_ClassifierInPackage");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		String key = UseCaseDiagramEditPart.MODEL_ID + "_ClassifierInPackage";
		store.setDefault(PreferenceConstantHelper.getElementConstant(key, PreferenceConstantHelper.WIDTH), 100);
		store.setDefault(PreferenceConstantHelper.getElementConstant(key, PreferenceConstantHelper.HEIGHT), 30);
