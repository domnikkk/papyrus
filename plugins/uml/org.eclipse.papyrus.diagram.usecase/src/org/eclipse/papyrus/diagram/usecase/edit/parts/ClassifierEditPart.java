...
import org.eclipse.papyrus.diagram.usecase.edit.policies.ClassifierItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ClassifierEditPart extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ClassifierItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof ClassifierNameEditPart) {
			((ClassifierNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassifierNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.usecase.edit.parts.ClassifierEditPart) {
			types.add(UMLElementTypes.Generalization_4010);
		}
