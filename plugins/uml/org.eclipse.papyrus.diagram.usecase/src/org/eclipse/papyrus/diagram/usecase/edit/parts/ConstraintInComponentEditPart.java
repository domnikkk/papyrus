...
import org.eclipse.papyrus.diagram.usecase.edit.policies.ConstraintInComponentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConstraintInComponentEditPart extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ConstraintInComponentItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof ConstraintInComponentNameEditPart) {
			((ConstraintInComponentNameEditPart)childEditPart).setLabel(getPrimaryShape().getCornerBentContentLabel());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.usecase.edit.parts.ConstraintInComponentEditPart) {
			types.add(UMLElementTypes.ConstraintConstrainedElement_4012);
		}
