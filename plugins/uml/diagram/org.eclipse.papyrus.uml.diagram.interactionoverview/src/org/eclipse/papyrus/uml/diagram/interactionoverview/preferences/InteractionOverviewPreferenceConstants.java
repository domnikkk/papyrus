...
public interface InteractionOverviewPreferenceConstants {
	...
	public static final String PREF_NEW_INTERACTION_SELECT_AS_DEFAULT = "org.eclipse.papyrus.uml.diagram.interactionoverview.Interaction.CreateDialog.selectAsDefault"; //$NON-NLS-1$

	public static final String PREF_NEW_INTERACTION_CREATION_OWNER = "org.eclipse.papyrus.uml.diagram.interactionoverview.Interaction.CreateDialog.owner"; //$NON-NLS-1$
