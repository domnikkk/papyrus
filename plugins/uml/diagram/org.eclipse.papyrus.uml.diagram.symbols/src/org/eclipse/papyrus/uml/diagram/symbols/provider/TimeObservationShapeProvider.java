...
/**
 * Shape Provider for {@link TimeObservation} or for {@link TypedElement} that are typed by an {@link TimeObservation}.
 */
public class TimeObservationShapeProvider extends AbstractShapeProvider {
	...
	public ProviderNotificationManager createProviderNotificationManager(DiagramEventBroker diagramEventBroker, EObject view, NotificationListener listener) {
		...
		TimeObservationShapeProviderNotificationManager notificationManager = new TimeObservationShapeProviderNotificationManager(diagramEventBroker, view, listener);
		return notificationManager;
	}

	/**
	 * Notification Manager for the {@link TimeObservationShapeProvider}.
	 */
	public class TimeObservationShapeProviderNotificationManager extends ProviderNotificationManager implements NotificationListener {

		/**
		 * Creates a new TimeObservationShapeProviderNotificationManager.
		 * 
		 ...
		 */
		public TimeObservationShapeProviderNotificationManager(DiagramEventBroker diagramEventBroker, EObject view, NotificationListener listener) {
	...
	public List<SVGDocument> getSVGDocument(EObject view) {
		if(providesShapes(view)) {
			URI uri = URI.createPlatformPluginURI(org.eclipse.papyrus.uml.diagram.common.Activator.ID + TIME_OBSERVATION_SVG_PATH, true);
