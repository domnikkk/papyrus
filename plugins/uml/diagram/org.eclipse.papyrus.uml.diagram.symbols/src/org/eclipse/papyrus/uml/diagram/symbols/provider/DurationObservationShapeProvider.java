 ...
 */
public class DurationObservationShapeProvider extends AbstractShapeProvider {
	...
	/**
	 * Notification Manager for the {@link DurationObservationShapeProvider}.
	 */
	...
	public List<SVGDocument> getSVGDocument(EObject view) {
		if(providesShapes(view)) {
			URI uri = URI.createPlatformPluginURI(org.eclipse.papyrus.uml.diagram.common.Activator.ID + DURATION_OBSERVATION_SVG_PATH, true);
