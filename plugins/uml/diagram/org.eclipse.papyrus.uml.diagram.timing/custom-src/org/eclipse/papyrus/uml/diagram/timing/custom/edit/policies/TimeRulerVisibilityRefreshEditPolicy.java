...
/**
 * This EditPolicy adds a notification listener on the time ruler View that listens for its visibility and updates the {@link LifelineFigure#setDisplayTimeRuler(boolean) LifelineFigure's time ruler visibility}
 */
