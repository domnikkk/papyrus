 ...
 * @generated
 */
public class CompactStateInvariantNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StateInvariant_28, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.timing.edit.parts.CompactStateInvariantNameEditPart.VISUAL_ID));
		}
		return parser;
	}
