 ...
 * @generated
 */
public class TickNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Node_26, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
