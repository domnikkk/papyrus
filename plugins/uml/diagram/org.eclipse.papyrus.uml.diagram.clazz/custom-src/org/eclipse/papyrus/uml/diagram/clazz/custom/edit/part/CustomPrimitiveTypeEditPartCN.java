...
/**
 * The Class CustomPrimitiveTypeEditPart.
 */
public class CustomPrimitiveTypeEditPartCN extends PrimitiveTypeEditPartCN {




	/**
	 * Instantiates a new custom primitive type edit part.
	 *
	 * @param view
	 *        the view
	 */
	public CustomPrimitiveTypeEditPartCN(View view) {
		super(view);
	}
