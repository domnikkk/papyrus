 ...
 * @generated
 */
public class AssociationClassNestedClassifierCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getAssociationClassNestedclassifiers_7037SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getAssociationClassNestedclassifiers_7037SemanticChildren((View)getHost().getModel());
