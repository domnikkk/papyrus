...
public class ClassCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getClass_2008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getClass_2008SemanticChildren((View)getHost().getModel());
