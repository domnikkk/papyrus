...
public class TemplateSignatureTemplateParameterCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getTemplateSignatureTemplateParameterCompartment_7038SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ClassifierTemplateParameterEditPart.VISUAL_ID || visualID == OperationTemplateParameterEditPart.VISUAL_ID || visualID == TemplateParameterEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getTemplateSignatureTemplateParameterCompartment_7038SemanticChildren((View) getHost().getModel());
