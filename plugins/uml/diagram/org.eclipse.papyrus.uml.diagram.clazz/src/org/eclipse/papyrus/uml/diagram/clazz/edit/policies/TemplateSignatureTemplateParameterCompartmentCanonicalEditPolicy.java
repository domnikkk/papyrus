...
public class TemplateSignatureTemplateParameterCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE
				.getTemplateSignatureTemplateParameterCompartment_7038SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors =
				CustomUMLDiagramUpdater.INSTANCE
						.getTemplateSignatureTemplateParameterCompartment_7038SemanticChildren((View) getHost().getModel());
