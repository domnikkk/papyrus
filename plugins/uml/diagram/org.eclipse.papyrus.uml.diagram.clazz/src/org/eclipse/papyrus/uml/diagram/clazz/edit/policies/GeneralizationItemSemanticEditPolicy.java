...
import org.eclipse.papyrus.uml.diagram.clazz.edit.commands.GeneralizationSetCreateCommand;
import org.eclipse.papyrus.uml.diagram.clazz.edit.commands.GeneralizationSetReorientCommand;
...
public class GeneralizationItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (UMLElementTypes.GeneralizationSet_4020 == baseElementType) {
			if (isExtendedType) {
