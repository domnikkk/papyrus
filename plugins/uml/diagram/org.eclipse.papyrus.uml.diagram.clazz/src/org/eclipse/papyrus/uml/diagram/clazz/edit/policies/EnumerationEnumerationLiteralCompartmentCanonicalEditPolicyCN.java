...
public class EnumerationEnumerationLiteralCompartmentCanonicalEditPolicyCN extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE
				.getEnumerationEnumerationLiteralCompartment_7031SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors =
				CustomUMLDiagramUpdater.INSTANCE
						.getEnumerationEnumerationLiteralCompartment_7031SemanticChildren((View) getHost().getModel());
