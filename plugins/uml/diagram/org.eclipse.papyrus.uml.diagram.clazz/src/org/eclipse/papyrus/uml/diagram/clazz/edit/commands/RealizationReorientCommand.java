...
public class RealizationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistRealization_4005(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Package container = (Package) getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistRealization_4005(container, getLink(), source, getNewTarget());
	}
