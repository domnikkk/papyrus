...
public class InformationFlowCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canCreateInformationFlow_4026(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_InformationFlow_4026(newElement);
