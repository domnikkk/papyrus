 ...
 * @generated
 */
public class InterfaceNestedClassifierCompartmentCanonicalEditPolicyCN extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getInterfaceNestedclassifiers_7029SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getInterfaceNestedclassifiers_7029SemanticChildren((View) getHost().getModel());
