...
public class InstanceSpecificationSlotCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getInstanceSpecificationSlots_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SlotEditPart.VISUAL_ID == UMLVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = CustomUMLDiagramUpdater.INSTANCE.getInstanceSpecificationSlots_7001SemanticChildren((View) getHost().getModel());
