...
public class InterfaceAttributeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getInterfaceAttributes_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getInterfaceAttributes_7008SemanticChildren((View)getHost().getModel());
