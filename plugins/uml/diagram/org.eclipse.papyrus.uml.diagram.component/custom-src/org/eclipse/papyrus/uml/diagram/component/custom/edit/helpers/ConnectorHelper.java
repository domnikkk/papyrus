...
public class ConnectorHelper extends ElementHelper {
	...
	public CompositeCommand dropConnector(Connector connector, int linkVisualID, EditPartViewer viewer, EditPart host, PreferencesHint diagramPreferencesHint, Point location, View containerView) {
		...
		CreateConnectionViewRequest.ConnectionViewDescriptor linkdescriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(UMLElementTypes.getElementType(linkVisualID),
				((IHintedType) UMLElementTypes.getElementType(linkVisualID)).getSemanticHint(), diagramPreferencesHint);
		 ...
		 */
		DiagramEditPart diagram = org.eclipse.papyrus.infra.gmfdiag.common.utils.DiagramEditPartsUtil.getDiagramEditPart(host);
		...
		if (sourceEditPart == null) {
			...
			if (!parentBounds.equals(LayoutUtils.getAbsolutePosition(diagram))) {
		...
		CommonDeferredCreateConnectionViewCommand aLinkCommand = new CommonDeferredCreateConnectionViewCommand(getEditingDomain(), ((IHintedType) UMLElementTypes.getElementType(linkVisualID)).getSemanticHint(), sourceAdapter, targetAdapter, viewer,
				diagramPreferencesHint, linkdescriptor, null);
