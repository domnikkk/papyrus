...
import org.eclipse.papyrus.uml.diagram.usecase.edit.commands.ExtendCreateCommand;
 ...
 * @generated
 */
public class UseCaseAsRectangleItemSemanticEditPolicyTN extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public UseCaseAsRectangleItemSemanticEditPolicyTN() {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (UMLElementTypes.Include_4008 == baseElementType) {
			if (isExtendedType) {
		...
		if (UMLElementTypes.Extend_4009 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
			return getGEFWrapper(new ExtendCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (UMLElementTypes.Generalization_4010 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
		...
		if (UMLElementTypes.Association_4011 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
		...
		if (UMLElementTypes.Dependency_4013 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
		...
		if (UMLElementTypes.CommentAnnotatedElement_4014 == baseElementType) {
			return null;
		}
		if (UMLElementTypes.Abstraction_4015 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
		...
		if (UMLElementTypes.Usage_4016 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
		...
		if (UMLElementTypes.Realization_4017 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
		...
		if (UMLElementTypes.PackageImport_4019 == baseElementType) {
			if (isExtendedType) {
				return getExtendedStartCreateRelationshipCommand(req, (IExtendedHintedElementType) requestElementType);
			}
