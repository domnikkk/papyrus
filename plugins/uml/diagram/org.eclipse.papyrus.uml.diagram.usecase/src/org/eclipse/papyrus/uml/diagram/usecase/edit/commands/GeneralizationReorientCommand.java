...
public class GeneralizationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistGeneralization_4010(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Classifier container = (Classifier) getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistGeneralization_4010(container, getLink(), source, getNewTarget());
	}
