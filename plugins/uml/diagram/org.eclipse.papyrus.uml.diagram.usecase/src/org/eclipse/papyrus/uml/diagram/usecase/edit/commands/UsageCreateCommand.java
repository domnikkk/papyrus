...
public class UsageCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canCreateUsage_4016(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_Usage_4016(newElement);
