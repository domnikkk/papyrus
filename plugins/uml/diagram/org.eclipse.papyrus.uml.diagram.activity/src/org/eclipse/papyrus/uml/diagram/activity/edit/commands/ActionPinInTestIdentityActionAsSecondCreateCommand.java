 ...
 * @generated
 */
public class ActionPinInTestIdentityActionAsSecondCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInTestIdentityActionAsSecondCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		TestIdentityAction container = (TestIdentityAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				TestIdentityAction qualifiedTarget = (TestIdentityAction) target;
				qualifiedTarget.setSecond(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3161(newElement);
