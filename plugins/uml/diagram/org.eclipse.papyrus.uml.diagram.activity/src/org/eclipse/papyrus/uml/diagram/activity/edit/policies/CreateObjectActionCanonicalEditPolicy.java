...
public class CreateObjectActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return UMLPackage.eINSTANCE.getCreateObjectAction_Result();
	}
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getCreateObjectAction_3086SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return OutputPinInCreateObjectActionAsResultEditPart.VISUAL_ID == UMLVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getCreateObjectAction_3086SemanticChildren((View) getHost().getModel());
