 ...
 * @generated
 */
public class ActionPinInBroadcastSignalActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInBroadcastSignalActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ActionInputPin_3180(newElement);
