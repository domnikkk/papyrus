 ...
 * @generated
 */
public class ValuePinInBroadcastSignalActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ValuePinInBroadcastSignalActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ValuePin_3179(newElement);
