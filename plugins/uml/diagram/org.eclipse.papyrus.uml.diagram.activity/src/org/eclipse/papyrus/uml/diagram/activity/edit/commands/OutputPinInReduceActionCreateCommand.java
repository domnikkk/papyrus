 ...
 * @generated
 */
public class OutputPinInReduceActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPinInReduceActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_OutputPin_3131(newElement);
