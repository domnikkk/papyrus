 ...
 * @generated
 */
public class CommentLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CommentLinkCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canCreateCommentAnnotatedElement_4006(getSource(), getTarget());
	}
