 ...
 * @generated
 */
public class TestIdentityActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set<EStructuralFeature> getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(UMLPackage.eINSTANCE.getTestIdentityAction_Result());
			myFeaturesToSynchronize.add(UMLPackage.eINSTANCE.getTestIdentityAction_First());
			myFeaturesToSynchronize.add(UMLPackage.eINSTANCE.getTestIdentityAction_Second());
		}
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getTestIdentityAction_3114SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getTestIdentityAction_3114SemanticChildren((View) getHost().getModel());
