...
public class ValueSpecificationActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return UMLPackage.eINSTANCE.getValueSpecificationAction_Result();
	}
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getValueSpecificationAction_3076SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return OutputPinInValSpecActEditPart.VISUAL_ID == UMLVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getValueSpecificationAction_3076SemanticChildren((View) getHost().getModel());
