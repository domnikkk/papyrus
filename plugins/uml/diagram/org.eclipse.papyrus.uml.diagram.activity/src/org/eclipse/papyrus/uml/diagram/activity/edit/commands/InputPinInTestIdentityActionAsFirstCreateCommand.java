 ...
 * @generated
 */
public class InputPinInTestIdentityActionAsFirstCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InputPinInTestIdentityActionAsFirstCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_InputPin_3134(newElement);
