 ...
 * @generated
 */
public class BroadcastSignalActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return UMLPackage.eINSTANCE.getInvocationAction_Argument();
	}
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getBroadcastSignalAction_3102SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getBroadcastSignalAction_3102SemanticChildren((View) getHost().getModel());
