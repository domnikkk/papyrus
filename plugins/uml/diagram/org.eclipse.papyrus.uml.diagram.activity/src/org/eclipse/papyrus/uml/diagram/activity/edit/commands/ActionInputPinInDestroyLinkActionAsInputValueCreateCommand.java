 ...
 * @generated
 */
public class ActionInputPinInDestroyLinkActionAsInputValueCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionInputPinInDestroyLinkActionAsInputValueCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				LinkAction qualifiedTarget = (LinkAction) target;
				qualifiedTarget.getInputValues().add(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3165(newElement);
