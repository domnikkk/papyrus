 ...
 * @generated
 */
public class ValuePinInTestIdentityActionAsFirstCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ValuePinInTestIdentityActionAsFirstCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ValuePin_3147(newElement);
