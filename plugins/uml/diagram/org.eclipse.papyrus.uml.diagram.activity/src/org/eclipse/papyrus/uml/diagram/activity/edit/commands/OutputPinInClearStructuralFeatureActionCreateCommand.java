 ...
 * @generated
 */
public class OutputPinInClearStructuralFeatureActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPinInClearStructuralFeatureActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		ClearStructuralFeatureAction container = (ClearStructuralFeatureAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				ClearStructuralFeatureAction qualifiedTarget = (ClearStructuralFeatureAction) target;
				qualifiedTarget.setResult(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_OutputPin_3127(newElement);
