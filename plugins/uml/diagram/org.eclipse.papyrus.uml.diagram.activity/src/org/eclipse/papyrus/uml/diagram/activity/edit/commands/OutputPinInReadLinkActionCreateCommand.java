 ...
 * @generated
 */
public class OutputPinInReadLinkActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPinInReadLinkActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		ReadLinkAction container = (ReadLinkAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				ReadLinkAction qualifiedTarget = (ReadLinkAction) target;
				qualifiedTarget.setResult(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_OutputPin_3128(newElement);
