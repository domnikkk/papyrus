 ...
 * @generated
 */
public class ActionPinInTestIdentityActionAsFirstCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInTestIdentityActionAsFirstCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				qualifiedTarget.setFirst(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3160(newElement);
