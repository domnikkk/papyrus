 ...
 * @generated
 */
public class OutputPinInReadExtentActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPinInReadExtentActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		ReadExtentAction container = (ReadExtentAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				ReadExtentAction qualifiedTarget = (ReadExtentAction) target;
				qualifiedTarget.setResult(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_OutputPin_3129(newElement);
