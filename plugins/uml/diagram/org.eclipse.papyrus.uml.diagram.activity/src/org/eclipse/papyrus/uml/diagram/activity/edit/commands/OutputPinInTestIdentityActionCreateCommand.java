 ...
 * @generated
 */
public class OutputPinInTestIdentityActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPinInTestIdentityActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_OutputPin_3126(newElement);
