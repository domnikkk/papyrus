 ...
 * @generated
 */
public class ValuePinInCreateLinkActionAsInputValueAppliedStereotypeLabelEditPart extends AbstractLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.ValuePin_3151, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInCreateLinkActionAsInputValueAppliedStereotypeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
