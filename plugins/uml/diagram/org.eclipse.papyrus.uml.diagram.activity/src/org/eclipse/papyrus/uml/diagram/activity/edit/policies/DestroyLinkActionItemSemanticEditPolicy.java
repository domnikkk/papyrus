 ...
 * @generated
 */
public class DestroyLinkActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public DestroyLinkActionItemSemanticEditPolicy() {
		super(UMLElementTypes.DestroyLinkAction_3118);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UMLElementTypes.InputPin_3139 == requestElementType) {
		...
		if (UMLElementTypes.ValuePin_3152 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getLinkAction_InputValue();
			req.setContainmentFeature(containmentFeature);
			return getGEFWrapper(getSemanticCreationCommand(req));
		}
		if (UMLElementTypes.ActionInputPin_3165 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getLinkAction_InputValue();
			req.setContainmentFeature(containmentFeature);
			return getGEFWrapper(getSemanticCreationCommand(req));
