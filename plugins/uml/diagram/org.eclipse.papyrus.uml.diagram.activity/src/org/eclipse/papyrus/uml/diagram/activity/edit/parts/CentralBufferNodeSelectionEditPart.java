 ...
 * @generated
 */
public class CentralBufferNodeSelectionEditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CentralBufferNode_3104, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.CentralBufferNodeSelectionEditPart.VISUAL_ID));
		}
		return parser;
	}
