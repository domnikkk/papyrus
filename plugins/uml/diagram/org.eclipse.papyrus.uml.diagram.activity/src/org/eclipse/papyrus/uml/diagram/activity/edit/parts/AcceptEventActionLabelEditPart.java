 ...
 * @generated
 */
public class AcceptEventActionLabelEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart {
	...
	public void setLabel(WrappingLabel wrappingLabel) {
		...
		defaultText = getLabelTextHelper(wrappingLabel);
		registerVisuals();
		refreshVisuals();
	}
