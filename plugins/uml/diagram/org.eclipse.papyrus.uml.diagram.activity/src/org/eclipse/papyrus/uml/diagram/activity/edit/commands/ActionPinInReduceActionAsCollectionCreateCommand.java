 ...
 * @generated
 */
public class ActionPinInReduceActionAsCollectionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInReduceActionAsCollectionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		ReduceAction container = (ReduceAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				ReduceAction qualifiedTarget = (ReduceAction) target;
				qualifiedTarget.setCollection(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3169(newElement);
