 ...
 * @generated
 */
public class ClearStructuralFeatureActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ClearStructuralFeatureActionItemSemanticEditPolicy() {
		super(UMLElementTypes.ClearStructuralFeatureAction_3115);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UMLElementTypes.OutputPin_3127 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getClearStructuralFeatureAction_Result();
			req.setContainmentFeature(containmentFeature);
			return getGEFWrapper(getSemanticCreationCommand(req));
		}
		if (UMLElementTypes.InputPin_3136 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getStructuralFeatureAction_Object();
			req.setContainmentFeature(containmentFeature);
			return getGEFWrapper(getSemanticCreationCommand(req));
		}
		if (UMLElementTypes.ValuePin_3149 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getStructuralFeatureAction_Object();
			req.setContainmentFeature(containmentFeature);
			return getGEFWrapper(getSemanticCreationCommand(req));
		}
		if (UMLElementTypes.ActionInputPin_3162 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getStructuralFeatureAction_Object();
			req.setContainmentFeature(containmentFeature);
			return getGEFWrapper(getSemanticCreationCommand(req));
