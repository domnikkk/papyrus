 ...
 * @generated
 */
public class StartObjectBehavoiurActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set<EStructuralFeature> getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(UMLPackage.eINSTANCE.getStartObjectBehaviorAction_Object());
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getStartObjectBehaviorAction_3113SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getStartObjectBehaviorAction_3113SemanticChildren((View) getHost().getModel());
