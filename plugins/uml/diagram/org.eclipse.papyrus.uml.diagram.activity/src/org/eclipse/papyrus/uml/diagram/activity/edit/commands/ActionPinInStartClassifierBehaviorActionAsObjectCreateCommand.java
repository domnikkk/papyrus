 ...
 * @generated
 */
public class ActionPinInStartClassifierBehaviorActionAsObjectCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInStartClassifierBehaviorActionAsObjectCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		StartClassifierBehaviorAction container = (StartClassifierBehaviorAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				StartClassifierBehaviorAction qualifiedTarget = (StartClassifierBehaviorAction) target;
				qualifiedTarget.setObject(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3170(newElement);
