...
public class LoopNodeStructuredActivityNodeContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getLoopNodeStructuredActivityNodeContentCompartment_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getLoopNodeStructuredActivityNodeContentCompartment_7010SemanticChildren((View) getHost().getModel());
