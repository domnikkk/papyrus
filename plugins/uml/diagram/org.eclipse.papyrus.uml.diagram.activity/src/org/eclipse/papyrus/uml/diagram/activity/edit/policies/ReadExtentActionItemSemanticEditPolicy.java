 ...
 * @generated
 */
public class ReadExtentActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ReadExtentActionItemSemanticEditPolicy() {
		super(UMLElementTypes.ReadExtentAction_3120);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UMLElementTypes.OutputPin_3129 == requestElementType) {
			// adjust the containment feature
			EReference containmentFeature = UMLPackage.eINSTANCE.getReadExtentAction_Result();
