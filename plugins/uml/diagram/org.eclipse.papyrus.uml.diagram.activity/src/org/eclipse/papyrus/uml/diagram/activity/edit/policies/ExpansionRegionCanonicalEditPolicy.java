...
public class ExpansionRegionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	/**
	 * @generated NOT I do not know why generation skips this necessary attribute for this class only
	 */
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getExpansionRegion_3070SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getExpansionRegion_3070SemanticChildren((View) getHost().getModel());
