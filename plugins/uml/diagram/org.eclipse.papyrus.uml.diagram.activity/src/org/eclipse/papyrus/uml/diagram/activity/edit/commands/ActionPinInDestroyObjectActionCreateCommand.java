 ...
 * @generated
 */
public class ActionPinInDestroyObjectActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInDestroyObjectActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ActionInputPin_3174(newElement);
