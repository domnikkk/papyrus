 ...
 * @generated
 */
public class ValuePinInDestroyObjectActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ValuePinInDestroyObjectActionCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ValuePin_3173(newElement);
