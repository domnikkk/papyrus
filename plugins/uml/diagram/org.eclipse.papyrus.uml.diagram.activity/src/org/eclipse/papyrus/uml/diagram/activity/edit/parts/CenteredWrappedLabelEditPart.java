 ...
 * @generated
 */
public class CenteredWrappedLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CenteredWrappedLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActivityParameterNode_3059, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.CenteredWrappedLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
