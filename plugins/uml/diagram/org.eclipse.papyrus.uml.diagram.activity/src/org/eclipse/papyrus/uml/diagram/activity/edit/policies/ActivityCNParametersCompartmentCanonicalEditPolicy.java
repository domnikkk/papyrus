...
public class ActivityCNParametersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getActivityActivityFigureParameterCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getActivityActivityFigureParameterCompartment_7014SemanticChildren((View) getHost().getModel());
