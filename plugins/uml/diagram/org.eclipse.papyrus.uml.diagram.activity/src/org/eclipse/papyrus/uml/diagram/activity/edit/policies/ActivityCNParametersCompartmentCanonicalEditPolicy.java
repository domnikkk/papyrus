 ...
 * @generated
 */
public class ActivityCNParametersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getActivityActivityFigureParameterCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getActivityActivityFigureParameterCompartment_7014SemanticChildren((View) getHost().getModel());
