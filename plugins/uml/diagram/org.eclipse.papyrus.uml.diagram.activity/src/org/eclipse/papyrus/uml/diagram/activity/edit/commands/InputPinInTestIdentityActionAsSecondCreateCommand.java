 ...
 * @generated
 */
public class InputPinInTestIdentityActionAsSecondCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InputPinInTestIdentityActionAsSecondCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_InputPin_3135(newElement);
