 ...
 * @generated
 */
public class ActionPinInStartObjectBehaviorActionAsObjectCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInStartObjectBehaviorActionAsObjectCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	public boolean canExecute() {
		StartObjectBehaviorAction container = (StartObjectBehaviorAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				StartObjectBehaviorAction qualifiedTarget = (StartObjectBehaviorAction) target;
				qualifiedTarget.setObject(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3158(newElement);
