 ...
 */
public class CustomConnectorMultiplicityTargetEditPart extends org.eclipse.papyrus.uml.diagram.composite.edit.parts.ConnectorMultiplicityTargetEditPart {

	/**
	 * Constructor.
	 */
	public CustomConnectorMultiplicityTargetEditPart(View view) {
		super(view);
	}
