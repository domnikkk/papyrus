...
import org.eclipse.papyrus.uml.diagram.composite.custom.edit.command.CustomConnectorCreateCommand;
import org.eclipse.papyrus.uml.diagram.composite.custom.edit.command.CustomPortCreateCommand;
 ...
 * </pre>
 */
public class CustomPropertyPartItemSemanticEditPolicyCN extends org.eclipse.papyrus.uml.diagram.composite.edit.policies.PropertyPartItemSemanticEditPolicyCN {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (UMLElementTypes.Port_3069 == req.getElementType()) {
			return getGEFWrapper(new CustomPortCreateCommand(req, DiagramUtils.getDiagramFrom(getHost())));
		}
