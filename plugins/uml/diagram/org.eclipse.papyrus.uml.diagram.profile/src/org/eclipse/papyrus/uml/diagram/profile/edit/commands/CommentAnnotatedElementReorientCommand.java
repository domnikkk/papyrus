...
public class CommentAnnotatedElementReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistCommentAnnotatedElement_1022(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistCommentAnnotatedElement_1022(getOldSource(), getNewTarget());
	}
