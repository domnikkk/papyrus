...
public class ElementImportReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistElementImport_1064(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Namespace container = (Namespace) getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistElementImport_1064(container, getLink(), source, getNewTarget());
	}
