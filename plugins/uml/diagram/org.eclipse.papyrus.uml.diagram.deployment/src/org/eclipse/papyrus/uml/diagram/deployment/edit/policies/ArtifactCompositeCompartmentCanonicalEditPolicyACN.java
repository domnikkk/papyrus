...
public class ArtifactCompositeCompartmentCanonicalEditPolicyACN extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getArtifactArtifactCompositeCompartment_34SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getArtifactArtifactCompositeCompartment_34SemanticChildren((View)getHost().getModel());
