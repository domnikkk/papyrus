...
public class CommentBodyEditPartCN extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Comment_8005, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.communication.edit.parts.CommentBodyEditPartCN.VISUAL_ID));
		}
		return parser;
	}
