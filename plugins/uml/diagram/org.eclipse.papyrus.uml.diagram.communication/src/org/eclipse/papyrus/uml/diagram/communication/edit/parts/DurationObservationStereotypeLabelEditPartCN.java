...
import org.eclipse.papyrus.uml.diagram.communication.providers.UMLParserProvider;
 ...
 * @generated
 */
public class DurationObservationStereotypeLabelEditPartCN extends PapyrusLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DurationObservation_8007, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.communication.edit.parts.DurationObservationStereotypeLabelEditPartCN.VISUAL_ID));
		}
		return parser;
	}
