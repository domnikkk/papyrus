...
public class StateMachineCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return UMLPackage.eINSTANCE.getStateMachine_ConnectionPoint();
	}
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getStateMachine_2000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == PseudostateEntryPointEditPart.VISUAL_ID || visualID == PseudostateExitPointEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.INSTANCE.getStateMachine_2000SemanticChildren((View)getHost().getModel());
