...
public class CustomRegionCompartmentXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	public Command createChangeConstraintCommand(ChangeBoundsRequest request, EditPart child, Object constraint) {
		...
		if (child instanceof StateEditPart) {
			...
			CustomStateResizeCommand resizeStateMachine = new CustomStateResizeCommand(adaptableForState, ((IGraphicalEditPart) getHost()).getDiagramPreferencesHint(), editingDomain, DiagramUIMessages.CreateCommand_Label, request, (Rectangle) constraint,
					false);
