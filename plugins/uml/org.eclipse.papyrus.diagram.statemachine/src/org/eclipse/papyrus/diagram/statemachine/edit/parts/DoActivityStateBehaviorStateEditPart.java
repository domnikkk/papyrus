...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.DoActivityStateBehaviorStateItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DoActivityStateBehaviorStateEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DoActivityStateBehaviorStateItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Behavior_691, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.DoActivityStateBehaviorStateEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	public class PropertyFigureDescriptor extends CenteredWrappedLabel {
