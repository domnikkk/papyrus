...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.EntryStateBehaviorItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EntryStateBehaviorEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EntryStateBehaviorItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Behavior_690, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.EntryStateBehaviorEditPart.VISUAL_ID));
		}
		return parser;
	}
