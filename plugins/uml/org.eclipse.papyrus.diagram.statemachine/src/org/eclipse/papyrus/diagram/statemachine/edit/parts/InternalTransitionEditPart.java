 ...
 * @generated
 */
public class InternalTransitionEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Transition_680, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.InternalTransitionEditPart.VISUAL_ID));
		}
		return parser;
	}
