...
public class OpaqueExpressionUtil {
	 ...
	 * <p>
	 * It returns <code>true</code> if both lists have the same size. It returns <code>false</code> if one of the list was bigger than the other one. In this latter case, one of the list was corrected, ie enough elements where added in the list
	 *
	 * @param opaqueExpression
