...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPinInLoopNodeAsVariableItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPinInLoopNodeAsVariableEditPart extends BorderedBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInLoopNodeAsVariableItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInLoopNodeAsVariableLabelEditPart || borderItemEditPart instanceof InputPinInStructuredActivityNodeAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInLoopNodeAsVariableEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
