...
import org.eclipse.papyrus.diagram.activity.edit.policies.OutputPinInLoopNodeAsResultItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPinInLoopNodeAsResultEditPart extends BorderedBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OutputPinInLoopNodeAsResultItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInLoopNodeAsResultLabelEditPart || borderItemEditPart instanceof OutputPinInLoopNodeAsResultAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInLoopNodeAsResultEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
