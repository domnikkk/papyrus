...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPinInRemoveStructuralFeatureValueActionAsObjectItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInRemoveStructuralFeatureValueActionAsObjectItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsObjectLabelEditPart || borderItemEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsObjectAppliedStereotypeWrappingLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinInRemoveStructuralFeatureValueActionAsObjectLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
