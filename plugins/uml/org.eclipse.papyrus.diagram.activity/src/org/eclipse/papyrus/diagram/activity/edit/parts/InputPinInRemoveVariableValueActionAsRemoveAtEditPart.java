...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPinInRemoveVariableValueActionAsRemoveAtItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPinInRemoveVariableValueActionAsRemoveAtEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InputPinInRemoveVariableValueActionAsRemoveAtEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInRemoveVariableValueActionAsRemoveAtItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInRemoveVariableValueActionAsRemoveAtLabelEditPart || borderItemEditPart instanceof InputPinInRemoveVariableValueActionAsRemoveAtAppliedStereotypeWrappingLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinInRemoveVariableValueActionAsRemoveAtLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveVariableValueActionAsRemoveAtEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
