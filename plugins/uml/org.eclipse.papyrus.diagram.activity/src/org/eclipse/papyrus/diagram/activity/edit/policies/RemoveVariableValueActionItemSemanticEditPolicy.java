 ...
 * @generated
 */
public class RemoveVariableValueActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RemoveVariableValueActionItemSemanticEditPolicy() {
		super(UMLElementTypes.RemoveVariableValueAction_3113);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if(UMLElementTypes.InputPin_3114 == req.getElementType()) {
			return getGEFWrapper(new InputPinInRemoveVariableValueActionAsRemoveAtCreateCommand(req));
		}
		if(UMLElementTypes.InputPin_3115 == req.getElementType()) {
			return getGEFWrapper(new InputPinInRemoveVariableValueActionAsValueCreateCommand(req));
		}
