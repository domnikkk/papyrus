...
import org.eclipse.papyrus.diagram.activity.edit.commands.InputPinInDestroyObjectActionCreateCommand;
...
public class DestroyObjectActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if(UMLElementTypes.InputPin_3096 == req.getElementType()) {
