 ...
 * @generated
 */
public class InputPinInRemoveVariableValueActionAsRemoveAtAppliedStereotypeWrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveVariableValueActionAsRemoveAtAppliedStereotypeWrappingLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinInRemoveVariableValueActionAsRemoveAtAppliedStereotypeWrappingLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3114, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveVariableValueActionAsRemoveAtAppliedStereotypeWrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
