 ...
 * @generated
 */
public class RemoveVariableValueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RemoveVariableValueActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.RemoveVariableValueAction_3113, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.RemoveVariableValueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
