...
import org.eclipse.papyrus.diagram.activity.edit.commands.InputPinInBroadcastSignalActionCreateCommand;
...
public class BroadcastSignalActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if(UMLElementTypes.InputPin_3103 == req.getElementType()) {
