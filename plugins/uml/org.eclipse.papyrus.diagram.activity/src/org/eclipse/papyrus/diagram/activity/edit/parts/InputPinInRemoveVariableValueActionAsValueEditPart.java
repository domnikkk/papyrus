...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPinInRemoveVariableValueActionAsValueItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPinInRemoveVariableValueActionAsValueEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InputPinInRemoveVariableValueActionAsValueEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInRemoveVariableValueActionAsValueItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInRemoveVariableValueActionAsValueLabelEditPart || borderItemEditPart instanceof InputPinInRemoveVariableValueActionAsValueAppliedStereotypeWrappingLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinInRemoveVariableValueActionAsValueLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveVariableValueActionAsValueEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
