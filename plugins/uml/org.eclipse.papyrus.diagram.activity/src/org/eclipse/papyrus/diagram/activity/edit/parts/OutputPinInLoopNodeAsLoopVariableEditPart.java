...
import org.eclipse.papyrus.diagram.activity.edit.policies.OutputPinInLoopNodeAsLoopVariableItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPinInLoopNodeAsLoopVariableEditPart extends BorderedBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OutputPinInLoopNodeAsLoopVariableItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInLoopNodeAsLoopVariableLabelEditPart || borderItemEditPart instanceof OutputPinInLoopNodeAsLoopVariableAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInLoopNodeAsLoopVariableEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
