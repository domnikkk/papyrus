 ...
 * @generated
 */
public class OutputPinInLoopNodeAsBodyOutputLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInLoopNodeAsBodyOutputLabelEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OutputPin_3109, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInLoopNodeAsBodyOutputLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
