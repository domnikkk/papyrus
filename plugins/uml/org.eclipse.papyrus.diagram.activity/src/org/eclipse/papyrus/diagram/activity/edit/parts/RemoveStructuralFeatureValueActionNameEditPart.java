 ...
 * @generated
 */
public class RemoveStructuralFeatureValueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RemoveStructuralFeatureValueActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.RemoveStructuralFeatureValueAction_3116, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.RemoveStructuralFeatureValueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
