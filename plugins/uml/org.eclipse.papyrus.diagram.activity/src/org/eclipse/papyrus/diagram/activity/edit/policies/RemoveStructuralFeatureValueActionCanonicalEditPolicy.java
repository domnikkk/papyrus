 ...
 * @generated
 */
public class RemoveStructuralFeatureValueActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getRemoveStructuralFeatureValueAction_3116SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart.VISUAL_ID || visualID == InputPinInRemoveStructuralFeatureValueActionAsValueEditPart.VISUAL_ID || visualID == OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getRemoveStructuralFeatureValueAction_3116SemanticChildren((View)getHost().getModel());
