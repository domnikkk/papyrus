...
public class DecisionInputEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DecisionInputEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DecisionNode_3038, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DecisionInputEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	/**
	 * @generated NOT refresh the visibility in case the decision input
	 *            assignment changed
	 */
		...
		if(NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
			...
			if(getParser() instanceof ISemanticParser) {
				...
				if(modelParser.areSemanticElementsAffected(null, event)) {
					...
					refreshLabel();
					// refresh the visibility in case the decision input
					// assignment changed
					refreshVisibility();
				}
			}
