...
import org.eclipse.papyrus.diagram.activity.edit.policies.RemoveStructuralFeatureValueActionCanonicalEditPolicy;
import org.eclipse.papyrus.diagram.activity.edit.policies.RemoveStructuralFeatureValueActionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RemoveStructuralFeatureValueActionEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public RemoveStructuralFeatureValueActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RemoveStructuralFeatureValueActionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.RemoveStructuralFeatureValueActionCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new RemoveStructuralFeatureValueActionCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof RemoveStructuralFeatureValueActionNameEditPart) {
			((RemoveStructuralFeatureValueActionNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		//Papyrus Gencode :Affixed Pin locator for Actions
		if(childEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.NORTH);
			getBorderedFigure().getBorderItemContainer().add(((InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart)childEditPart).getFigure(), locator);
			return true;
		}
		//Papyrus Gencode :Affixed Pin locator for Actions
		if(childEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsValueEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(((InputPinInRemoveStructuralFeatureValueActionAsValueEditPart)childEditPart).getFigure(), locator);
			return true;
		}
		//Papyrus Gencode :Affixed Pin locator for Actions
		if(childEditPart instanceof OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart)childEditPart).getFigure(), locator);
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if(childEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((InputPinInRemoveStructuralFeatureValueActionAsObjectEditPart)childEditPart).getFigure());
			return true;
		}
		if(childEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsValueEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((InputPinInRemoveStructuralFeatureValueActionAsValueEditPart)childEditPart).getFigure());
			return true;
		}
		if(childEditPart instanceof OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart)childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "RemoveStructuralFeatureValueAction";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(RemoveStructuralFeatureValueActionNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.RemoveStructuralFeatureValueActionEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor() || feature == NotationPackage.eINSTANCE.getFontStyle_FontColor() || feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()) {
			...
			if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("RemoveStructuralFeatureValueAction", PreferenceConstantHelper.COLOR_LINE);
			} else if(feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("RemoveStructuralFeatureValueAction", PreferenceConstantHelper.COLOR_FONT);
			} else if(feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("RemoveStructuralFeatureValueAction", PreferenceConstantHelper.COLOR_FILL);
			}
			result = FigureUtilities.RGBToInteger(PreferenceConverter.getColor((IPreferenceStore)preferenceStore, prefColor));
		} else if(feature == NotationPackage.eINSTANCE.getFillStyle_Transparency() || feature == NotationPackage.eINSTANCE.getFillStyle_Gradient()) {
			String prefGradient = PreferenceConstantHelper.getElementConstant("RemoveStructuralFeatureValueAction", PreferenceConstantHelper.COLOR_GRADIENT);
