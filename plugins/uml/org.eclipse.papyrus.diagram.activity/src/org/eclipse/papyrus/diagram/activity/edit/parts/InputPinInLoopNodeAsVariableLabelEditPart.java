 ...
 * @generated
 */
public class InputPinInLoopNodeAsVariableLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInLoopNodeAsVariableLabelEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3105, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInLoopNodeAsVariableLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
