...
import org.eclipse.papyrus.diagram.activity.edit.policies.RemoveVariableValueActionCanonicalEditPolicy;
import org.eclipse.papyrus.diagram.activity.edit.policies.RemoveVariableValueActionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RemoveVariableValueActionEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public RemoveVariableValueActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RemoveVariableValueActionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.RemoveVariableValueActionCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new RemoveVariableValueActionCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof RemoveVariableValueActionNameEditPart) {
			((RemoveVariableValueActionNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		//Papyrus Gencode :Affixed Pin locator for Actions
		if(childEditPart instanceof InputPinInRemoveVariableValueActionAsRemoveAtEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(((InputPinInRemoveVariableValueActionAsRemoveAtEditPart)childEditPart).getFigure(), locator);
			return true;
		}
		//Papyrus Gencode :Affixed Pin locator for Actions
		if(childEditPart instanceof InputPinInRemoveVariableValueActionAsValueEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.NORTH);
			getBorderedFigure().getBorderItemContainer().add(((InputPinInRemoveVariableValueActionAsValueEditPart)childEditPart).getFigure(), locator);
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if(childEditPart instanceof InputPinInRemoveVariableValueActionAsRemoveAtEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((InputPinInRemoveVariableValueActionAsRemoveAtEditPart)childEditPart).getFigure());
			return true;
		}
		if(childEditPart instanceof InputPinInRemoveVariableValueActionAsValueEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((InputPinInRemoveVariableValueActionAsValueEditPart)childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "RemoveVariableValueAction";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(RemoveVariableValueActionNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.RemoveVariableValueActionEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor() || feature == NotationPackage.eINSTANCE.getFontStyle_FontColor() || feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()) {
			...
			if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("RemoveVariableValueAction", PreferenceConstantHelper.COLOR_LINE);
			} else if(feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("RemoveVariableValueAction", PreferenceConstantHelper.COLOR_FONT);
			} else if(feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("RemoveVariableValueAction", PreferenceConstantHelper.COLOR_FILL);
			}
			result = FigureUtilities.RGBToInteger(PreferenceConverter.getColor((IPreferenceStore)preferenceStore, prefColor));
		} else if(feature == NotationPackage.eINSTANCE.getFillStyle_Transparency() || feature == NotationPackage.eINSTANCE.getFillStyle_Gradient()) {
			String prefGradient = PreferenceConstantHelper.getElementConstant("RemoveVariableValueAction", PreferenceConstantHelper.COLOR_GRADIENT);
