...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPinInRemoveStructuralFeatureValueActionAsValueItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPinInRemoveStructuralFeatureValueActionAsValueEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InputPinInRemoveStructuralFeatureValueActionAsValueEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInRemoveStructuralFeatureValueActionAsValueItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsValueLabel2EditPart || borderItemEditPart instanceof InputPinInRemoveStructuralFeatureValueActionAsValueAppliedStereotypeWrappingLabel2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinInRemoveStructuralFeatureValueActionAsValueLabel2EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveStructuralFeatureValueActionAsValueEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
