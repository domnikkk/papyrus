 ...
 * @generated
 */
public class OutputPinInLoopNodeAsLoopVariableLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInLoopNodeAsLoopVariableLabelEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OutputPin_3110, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInLoopNodeAsLoopVariableLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
