...
public class ActivityCNContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getActivityActivityFigureContentCompartment_7013SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getActivityActivityFigureContentCompartment_7013SemanticChildren((View)getHost().getModel());
