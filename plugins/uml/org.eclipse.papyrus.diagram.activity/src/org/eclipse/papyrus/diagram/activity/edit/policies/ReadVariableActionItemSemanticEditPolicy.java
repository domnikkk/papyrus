...
import org.eclipse.papyrus.diagram.activity.edit.commands.OutputPinInReadVariableActionAsResultCreateCommand;
...
public class ReadVariableActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if(UMLElementTypes.OutputPin_3098 == req.getElementType()) {
