...
import org.eclipse.papyrus.diagram.activity.edit.commands.OutputPinInCreateObjectActionAsResultCreateCommand;
...
public class CreateObjectActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if(UMLElementTypes.OutputPin_3087 == req.getElementType()) {
