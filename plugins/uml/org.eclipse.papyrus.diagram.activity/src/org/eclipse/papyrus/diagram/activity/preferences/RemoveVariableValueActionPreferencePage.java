 ...
 * @generated
 */
public class RemoveVariableValueActionPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public RemoveVariableValueActionPreferencePage() {
		super();
		setPreferenceKey(ActivityDiagramEditPart.MODEL_ID + "_RemoveVariableValueAction");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		String key = ActivityDiagramEditPart.MODEL_ID + "_RemoveVariableValueAction";
