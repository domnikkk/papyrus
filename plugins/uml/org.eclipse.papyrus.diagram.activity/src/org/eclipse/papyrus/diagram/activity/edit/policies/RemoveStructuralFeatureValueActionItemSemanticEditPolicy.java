 ...
 * @generated
 */
public class RemoveStructuralFeatureValueActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RemoveStructuralFeatureValueActionItemSemanticEditPolicy() {
		super(UMLElementTypes.RemoveStructuralFeatureValueAction_3116);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if(UMLElementTypes.InputPin_3117 == req.getElementType()) {
			return getGEFWrapper(new InputPinInRemoveStructuralFeatureValueActionAsObjectCreateCommand(req));
		}
		if(UMLElementTypes.InputPin_3119 == req.getElementType()) {
			return getGEFWrapper(new InputPinInRemoveStructuralFeatureValueActionAsValueCreateCommand(req));
		}
		if(UMLElementTypes.OutputPin_3120 == req.getElementType()) {
			return getGEFWrapper(new OutputPinInRemoveStructuralFeatureValueActionAsResultCreateCommand(req));
		}
