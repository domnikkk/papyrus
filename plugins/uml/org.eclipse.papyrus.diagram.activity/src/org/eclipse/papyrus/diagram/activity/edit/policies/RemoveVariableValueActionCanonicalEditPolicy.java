 ...
 * @generated
 */
public class RemoveVariableValueActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if(myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(UMLPackage.eINSTANCE.getRemoveVariableValueAction_RemoveAt());
			myFeaturesToSynchronize.add(UMLPackage.eINSTANCE.getWriteVariableAction_Value());
		}
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getRemoveVariableValueAction_3113SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == InputPinInRemoveVariableValueActionAsRemoveAtEditPart.VISUAL_ID || visualID == InputPinInRemoveVariableValueActionAsValueEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getRemoveVariableValueAction_3113SemanticChildren((View)getHost().getModel());
