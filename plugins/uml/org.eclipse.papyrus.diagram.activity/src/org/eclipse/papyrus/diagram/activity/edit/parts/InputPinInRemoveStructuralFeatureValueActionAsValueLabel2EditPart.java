 ...
 * @generated
 */
public class InputPinInRemoveStructuralFeatureValueActionAsValueLabel2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveStructuralFeatureValueActionAsValueLabel2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinInRemoveStructuralFeatureValueActionAsValueLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3119, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveStructuralFeatureValueActionAsValueLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
