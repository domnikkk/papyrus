 ...
 * @generated
 */
public class OutputPinInRemoveStructuralFeatureValueActionAsResultLabel3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInRemoveStructuralFeatureValueActionAsResultLabel3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public OutputPinInRemoveStructuralFeatureValueActionAsResultLabel3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OutputPin_3120, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInRemoveStructuralFeatureValueActionAsResultLabel3EditPart.VISUAL_ID));
		}
		return parser;
	}
