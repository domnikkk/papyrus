...
import org.eclipse.papyrus.diagram.activity.edit.policies.OutputPinInRemoveStructuralFeatureValueActionAsResultItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OutputPinInRemoveStructuralFeatureValueActionAsResultItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInRemoveStructuralFeatureValueActionAsResultLabel3EditPart || borderItemEditPart instanceof OutputPinInRemoveStructuralFeatureValueActionAsResultAppliedStereotypeWrappingLabel3EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OutputPinInRemoveStructuralFeatureValueActionAsResultLabel3EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
		if(targetEditPart instanceof InitialNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4004);
