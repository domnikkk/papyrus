...
import org.eclipse.papyrus.diagram.activity.edit.policies.OutputPinInReadVariableActionAsResultItemSemanticEditPolicy;
...
public class OutputPinInReadVariableActionAsResultEditPart extends BorderedBorderItemEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.OutputPinInReadVariableActionAsResultEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
