 ...
 * @generated
 */
public class RemoveStructuralFeatureValueActionPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public RemoveStructuralFeatureValueActionPreferencePage() {
		super();
		setPreferenceKey(ActivityDiagramEditPart.MODEL_ID + "_RemoveStructuralFeatureValueAction");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		String key = ActivityDiagramEditPart.MODEL_ID + "_RemoveStructuralFeatureValueAction";
