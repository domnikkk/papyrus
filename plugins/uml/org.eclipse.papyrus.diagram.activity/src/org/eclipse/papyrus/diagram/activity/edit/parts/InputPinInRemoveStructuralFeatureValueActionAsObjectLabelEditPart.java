 ...
 * @generated
 */
public class InputPinInRemoveStructuralFeatureValueActionAsObjectLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveStructuralFeatureValueActionAsObjectLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinInRemoveStructuralFeatureValueActionAsObjectLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3117, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveStructuralFeatureValueActionAsObjectLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
