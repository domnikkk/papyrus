 ...
 * @generated
 */
public class InputPinInRemoveVariableValueActionAsValueAppliedStereotypeWrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveVariableValueActionAsValueAppliedStereotypeWrappingLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinInRemoveVariableValueActionAsValueAppliedStereotypeWrappingLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3115, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInRemoveVariableValueActionAsValueAppliedStereotypeWrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
