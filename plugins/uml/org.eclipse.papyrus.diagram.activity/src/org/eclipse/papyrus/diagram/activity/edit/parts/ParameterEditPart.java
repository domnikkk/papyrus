...
import org.eclipse.papyrus.diagram.activity.edit.policies.ParameterItemSemanticEditPolicy;
...
public class ParameterEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Parameter_3001, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ParameterEditPart.VISUAL_ID));
		}
		return parser;
	}
