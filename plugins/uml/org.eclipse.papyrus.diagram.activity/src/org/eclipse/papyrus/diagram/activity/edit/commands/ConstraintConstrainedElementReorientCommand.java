...
public class ConstraintConstrainedElementReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistConstraintConstrainedElement_4007(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistConstraintConstrainedElement_4007(getOldSource(), getNewTarget());
	}
