...
public class CustomOutputPinInRemoveStructuralFeatureValueActionAsResultEditPart extends OutputPinInRemoveStructuralFeatureValueActionAsResultEditPart {

	public CustomOutputPinInRemoveStructuralFeatureValueActionAsResultEditPart(View view) {
		super(view);
	}
