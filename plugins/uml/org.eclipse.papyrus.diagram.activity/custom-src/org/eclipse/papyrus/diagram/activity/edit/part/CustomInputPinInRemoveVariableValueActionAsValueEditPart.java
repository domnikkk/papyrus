...
public class CustomInputPinInRemoveVariableValueActionAsValueEditPart extends InputPinInRemoveVariableValueActionAsValueEditPart {

	public CustomInputPinInRemoveVariableValueActionAsValueEditPart(View view) {
		super(view);
	}
