...
public class CustomInputPinInRemoveVariableValueActionAsRemoveAtEditPart extends InputPinInRemoveVariableValueActionAsRemoveAtEditPart {

	public CustomInputPinInRemoveVariableValueActionAsRemoveAtEditPart(View view) {
		super(view);
	}
