...
public class CustomInputPinInRemoveStructuralFeatureValueActionAsValueEditPart extends InputPinInRemoveStructuralFeatureValueActionAsValueEditPart {

	public CustomInputPinInRemoveStructuralFeatureValueActionAsValueEditPart(View view) {
		super(view);
	}
