...
import org.eclipse.papyrus.diagram.common.commands.CreateAppliedStereotypeViewCommand;
import org.eclipse.papyrus.diagram.common.commands.SetNodeVisibilityCommand;
...
public class AppliedStereotypeCompartmentEditPolicy extends AppliedStereotypeNodeLabelDisplayEditPolicy {
	...
	protected boolean hasToDisplayCompartment(EObject applicationOfStereotype) {
		...
		if( !(stereotypesLocalizationToDisplay.equals(VisualInformationPapyrusConstant.STEREOTYPE_COMPARTMENT_LOCATION))){
			return false;
		}
