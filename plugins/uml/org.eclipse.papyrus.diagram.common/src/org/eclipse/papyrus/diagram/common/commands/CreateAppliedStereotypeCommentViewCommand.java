...
public class CreateAppliedStereotypeCommentViewCommand extends RecordingCommand {
	...
	public void doExecute() {
		...
		//copy EAnnotation
		final EAnnotation stereotypeAnnotation=owner.getEAnnotation(VisualInformationPapyrusConstant.STEREOTYPE_ANNOTATION);
		...
		RecordingCommand cmd=AppliedStereotypeHelper.getSetAppliedStereotypePropertiesLocalizationCommand(domain, node, VisualInformationPapyrusConstant.STEREOTYPE_COMPARTMENT_LOCATION);
		cmd.execute();
