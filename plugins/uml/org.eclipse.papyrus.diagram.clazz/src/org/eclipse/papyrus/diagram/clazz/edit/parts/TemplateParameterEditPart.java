...
public class TemplateParameterEditPart extends AbstractTemplateParameterEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.TemplateParameter_3016, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.TemplateParameterEditPart.VISUAL_ID));
		}
		return parser;
	}
