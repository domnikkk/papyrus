...
import org.eclipse.papyrus.diagram.clazz.edit.policies.NestedInterfaceForComponentItemSemanticEditPolicy;
...
public class NestedInterfaceForComponentEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Interface_3037, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.NestedInterfaceForComponentEditPart.VISUAL_ID));
		}
		return parser;
	}
