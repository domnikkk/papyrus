...
import org.eclipse.papyrus.diagram.clazz.edit.policies.NestedInterfaceForInterfaceItemSemanticEditPolicy;
...
public class NestedInterfaceForInterfaceEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Interface_3038, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.NestedInterfaceForInterfaceEditPart.VISUAL_ID));
		}
		return parser;
	}
