...
import org.eclipse.papyrus.diagram.clazz.edit.policies.ConnectableElementTemplateParameterItemSemanticEditPolicy;
...
public class ConnectableElementTemplateParameterEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ConnectableElementTemplateParameter_3034, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.ConnectableElementTemplateParameterEditPart.VISUAL_ID));
		}
		return parser;
	}
