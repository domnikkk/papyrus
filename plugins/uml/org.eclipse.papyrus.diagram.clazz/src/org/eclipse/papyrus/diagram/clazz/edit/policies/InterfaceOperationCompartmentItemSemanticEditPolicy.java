...
import org.eclipse.papyrus.diagram.clazz.edit.commands.OperationForInterfaceCreateCommand;
...
public class InterfaceOperationCompartmentItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Iterable<EReference> getCompartmentReferences() {
		if(compartmentReferences == null) {
			...
			compartmentReferences.add(UMLPackage.eINSTANCE.getInterface_OwnedOperation());
		}
