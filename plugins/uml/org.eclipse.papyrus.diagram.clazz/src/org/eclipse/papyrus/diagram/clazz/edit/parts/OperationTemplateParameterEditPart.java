...
public class OperationTemplateParameterEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OperationTemplateParameter_3035, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.OperationTemplateParameterEditPart.VISUAL_ID));
		}
		return parser;
	}
