...
import org.eclipse.papyrus.diagram.clazz.custom.policies.SlotDisplayEditPolicy;
...
public class SlotEditPart extends UMLCompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Slot_3030, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.SlotEditPart.VISUAL_ID));
		}
		return parser;
	}
