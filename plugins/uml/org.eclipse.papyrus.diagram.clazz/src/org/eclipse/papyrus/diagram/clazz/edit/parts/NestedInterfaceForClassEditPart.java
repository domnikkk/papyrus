...
import org.eclipse.papyrus.diagram.clazz.edit.policies.NestedInterfaceForClassItemSemanticEditPolicy;
...
public class NestedInterfaceForClassEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Interface_3036, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.NestedInterfaceForClassEditPart.VISUAL_ID));
		}
		return parser;
	}
