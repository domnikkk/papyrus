 ...
 *
 */
public class StereotypeQualifiedNameContentProposal extends AbstractStereotypeContentProposal implements IContentProposal, Comparable<IContentProposal> {
	 ...
	 * @param stereotype
	 */
	public StereotypeQualifiedNameContentProposal(Stereotype stereotype) {
		super( stereotype );
	}
