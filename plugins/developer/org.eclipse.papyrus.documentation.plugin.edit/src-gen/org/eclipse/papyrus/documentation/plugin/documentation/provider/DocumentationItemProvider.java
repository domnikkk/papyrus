...
public class DocumentationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DocumentationPackage.Literals.DOCUMENTATION__IMPLICIT_DEPENDENCIES);
			childrenFeatures.add(DocumentationPackage.Literals.DOCUMENTATION__REFERENT);
			childrenFeatures.add(DocumentationPackage.Literals.DOCUMENTATION__ADDITIONAL_COMMENTS);
		}
