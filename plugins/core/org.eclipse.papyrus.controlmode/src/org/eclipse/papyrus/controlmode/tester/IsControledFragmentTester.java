 ...
 ******************************************************************************/
package org.eclipse.papyrus.controlmode.tester;
 ...
 * 
 */
public class IsControledFragmentTester extends org.eclipse.core.expressions.PropertyTester {

	/**
	 * Property testing that an element is a model framgent
	 */
	...
	private Object isModelFragment(Object receiver) {
		if(receiver instanceof IStructuredSelection) {
			EObject eObject = getSemanticObject(((IStructuredSelection)receiver).getFirstElement());
			if(eObject != null) {
				return ControlCommandHelper.isRootControledObject(eObject);
			}
		}
		return false;
	}
