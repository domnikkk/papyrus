...
import org.eclipse.papyrus.sysml.diagram.requirement.edit.policy.RequirementInfoLabelUpdateEditPolicy;
...
public abstract class AbstractRequirementInformationLabelEditPart extends LabelEditPart {
	...
	protected void createDefaultEditPolicies() {
		 ...
		 */
		installEditPolicy(AppliedStereotypeLabelDisplayEditPolicy.STEREOTYPE_LABEL_POLICY, new RequirementInfoLabelUpdateEditPolicy());
