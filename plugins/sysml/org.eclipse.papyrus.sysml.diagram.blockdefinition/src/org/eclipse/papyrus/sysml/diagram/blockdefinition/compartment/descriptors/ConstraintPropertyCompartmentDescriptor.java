...
public class ConstraintPropertyCompartmentDescriptor implements IPropertyCompartmentDescriptor {

	/**
	 * {@inheritDoc}
	 */
	public String getType() {
		return SysMLGraphicalTypes.COMPARTMENT_SYSML_CONSTRAINT_AS_LIST_ID;
	}
