...
public class FlowPropertyCompartmentDescriptor implements IPropertyCompartmentDescriptor {

	/**
	 * {@inheritDoc}
	 */
	public String getType() {
		return SysMLGraphicalTypes.COMPARTMENT_SYSML_FLOWPROPERTY_AS_LIST_ID;
	}
