...
public class ArrangePortsAction extends AbstractAction {
	...
	public static String ID = "papyrus.arrangePortAction";
	
	public ArrangePortsAction() {
		setId(ID);
		setText("Arrange ports on the selected element");////$NON-NLS-1$
		setToolTipText("Arrange ports position on the selected element");////$NON-NLS-1$
	}
